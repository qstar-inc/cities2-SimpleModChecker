...
{
    public class AdjustAllSpeedLimitsSettings : SettingsBackup
    {
        public int SpeedUnitPreference
        {
            get => (int)GetValue(nameof(SpeedUnitPreference));
            set => SetValue(nameof(SpeedUnitPreference), value);
        }
        public bool SyncSliderWithSelection
        {
            get => (bool)GetValue(nameof(SyncSliderWithSelection));
            set => SetValue(nameof(SyncSliderWithSelection), value);
        }
        public int PanelSliderIncrement
        {
            get => (int)GetValue(nameof(PanelSliderIncrement));
            set => SetValue(nameof(PanelSliderIncrement), value);
        }
        public int TooltipFontScale
        {
            get => (int)GetValue(nameof(TooltipFontScale));
            set => SetValue(nameof(TooltipFontScale), value);
        }
        public bool DoubleSpeedDisplay
        {
            get => (bool)GetValue(nameof(DoubleSpeedDisplay));
            set => SetValue(nameof(DoubleSpeedDisplay), value);
        }
        ...
        public bool HideSpeedMarkers
        {
            get => (bool)GetValue(nameof(HideSpeedMarkers));
            set => SetValue(nameof(HideSpeedMarkers), value);
        }

        //public int ToolPanelPositionX
        //{
        //    get => (int)GetValue(nameof(ToolPanelPositionX));
        //    set => SetValue(nameof(ToolPanelPositionX), value);
        //}
        //public int ToolPanelPositionY
        //{
        //    get => (int)GetValue(nameof(ToolPanelPositionY));
        //    set => SetValue(nameof(ToolPanelPositionY), value);
        //}
        public bool SelectionInfoExpanded
        {
            get => (bool)GetValue(nameof(SelectionInfoExpanded));
            set => SetValue(nameof(SelectionInfoExpanded), value);
        }
        public bool SliderExpanded
        {
            get => (bool)GetValue(nameof(SliderExpanded));
            set => SetValue(nameof(SliderExpanded), value);
        }
        public bool WholeCityExpanded
        {
            get => (bool)GetValue(nameof(WholeCityExpanded));
            set => SetValue(nameof(WholeCityExpanded), value);
        }
        public bool StatsExpanded
        {
            get => (bool)GetValue(nameof(StatsExpanded));
            set => SetValue(nameof(StatsExpanded), value);
        }
    ...
    public class AdjustSchoolCapacitySettings : SettingsBackup
    {
        ...
        {
            get => (bool)GetValue(nameof(ControlEducationFees));
            set => SetValue(nameof(ControlEducationFees), value);
        }
        public int ElementaryFeePercent
        {
            get => (int)GetValue(nameof(ElementaryFeePercent));
            set => SetValue(nameof(ElementaryFeePercent), value);
        }
        public int HighSchoolFeePercent
        {
            get => (int)GetValue(nameof(HighSchoolFeePercent));
            set => SetValue(nameof(HighSchoolFeePercent), value);
        }
        public int HigherEducationFeePercent
        {
            get => (int)GetValue(nameof(HigherEducationFeePercent));
            set => SetValue(nameof(HigherEducationFeePercent), value);
        }
    }
    ...
    public class AdvancedRoadNamingSettings : SettingsBackup
    {
        ...
        {
            get => (string)GetValue(nameof(OrderingModeOption));
            set => SetValue(nameof(OrderingModeOption), value);
        }
        ...
        public bool EnableRouteShields
        {
            get => (bool)GetValue(nameof(EnableRouteShields));
            set => SetValue(nameof(EnableRouteShields), value);
        }
        public int RouteShieldSpacingPreset
        {
            get => (int)GetValue(nameof(RouteShieldSpacingPreset));
            set => SetValue(nameof(RouteShieldSpacingPreset), value);
        }
        public string RouteShieldSpacingOption
        {
            get => (string)GetValue(nameof(RouteShieldSpacingOption));
            set => SetValue(nameof(RouteShieldSpacingOption), value);
        }
        public int RouteShieldSizePreset
        {
            get => (int)GetValue(nameof(RouteShieldSizePreset));
            set => SetValue(nameof(RouteShieldSizePreset), value);
        }
        public string RouteShieldSizeOption
        {
            get => (string)GetValue(nameof(RouteShieldSizeOption));
            set => SetValue(nameof(RouteShieldSizeOption), value);
        }
        public bool EnableRouteShieldOcclusion
        {
            get => (bool)GetValue(nameof(EnableRouteShieldOcclusion));
            set => SetValue(nameof(EnableRouteShieldOcclusion), value);
        }
        public int RouteShieldOcclusionAngle
        {
            get => (int)GetValue(nameof(RouteShieldOcclusionAngle));
            set => SetValue(nameof(RouteShieldOcclusionAngle), value);
        }
        public bool EnableRouteStatistics
        {
            get => (bool)GetValue(nameof(EnableRouteStatistics));
            set => SetValue(nameof(EnableRouteStatistics), value);
        }
        public int StatisticsPreset
        {
            get => (int)GetValue(nameof(StatisticsPreset));
            set => SetValue(nameof(StatisticsPreset), value);
        }
        public string StatisticsPresetOption
        {
            get => (string)GetValue(nameof(StatisticsPresetOption));
            set => SetValue(nameof(StatisticsPresetOption), value);
        }
        public int StatisticsVolumeMode
        {
            get => (int)GetValue(nameof(StatisticsVolumeMode));
            set => SetValue(nameof(StatisticsVolumeMode), value);
        }
        public string StatisticsVolumeModeOption
        {
            get => (string)GetValue(nameof(StatisticsVolumeModeOption));
            set => SetValue(nameof(StatisticsVolumeModeOption), value);
        }
        public int StatisticsFlowMode
        {
            get => (int)GetValue(nameof(StatisticsFlowMode));
            set => SetValue(nameof(StatisticsFlowMode), value);
        }
        public string StatisticsFlowModeOption
        {
            get => (string)GetValue(nameof(StatisticsFlowModeOption));
            set => SetValue(nameof(StatisticsFlowModeOption), value);
        }
        public int StatisticsBusySegmentShare
        {
            get => (int)GetValue(nameof(StatisticsBusySegmentShare));
            set => SetValue(nameof(StatisticsBusySegmentShare), value);
        }
        public int StatisticsBusyVolumePercentile
        {
            get => (int)GetValue(nameof(StatisticsBusyVolumePercentile));
            set => SetValue(nameof(StatisticsBusyVolumePercentile), value);
        }
        public int StatisticsBottleneckSegmentShare
        {
            get => (int)GetValue(nameof(StatisticsBottleneckSegmentShare));
            set => SetValue(nameof(StatisticsBottleneckSegmentShare), value);
        }
        public int StatisticsCongestionFlowThreshold
        {
            get => (int)GetValue(nameof(StatisticsCongestionFlowThreshold));
            set => SetValue(nameof(StatisticsCongestionFlowThreshold), value);
        }
        public int StatisticsRefreshRate
        {
            get => (int)GetValue(nameof(StatisticsRefreshRate));
            set => SetValue(nameof(StatisticsRefreshRate), value);
        }
        public string StatisticsRefreshRateOption
        {
            get => (string)GetValue(nameof(StatisticsRefreshRateOption));
            set => SetValue(nameof(StatisticsRefreshRateOption), value);
        }
        public bool EnableSavedRenameRoutes
        {
            get => (bool)GetValue(nameof(EnableSavedRenameRoutes));
            set => SetValue(nameof(EnableSavedRenameRoutes), value);
        }
        ...
        //}
        public bool RouteStatisticsDefaultMigrated
        {
            get => (bool)GetValue(nameof(RouteStatisticsDefaultMigrated));
            set => SetValue(nameof(RouteStatisticsDefaultMigrated), value);
        }
        public bool RouteShieldsDefaultMigrated
        {
            get => (bool)GetValue(nameof(RouteShieldsDefaultMigrated));
            set => SetValue(nameof(RouteShieldsDefaultMigrated), value);
        }
        public bool SavedRenameRoutesDefaultMigrated
        {
            get => (bool)GetValue(nameof(SavedRenameRoutesDefaultMigrated));
            set => SetValue(nameof(SavedRenameRoutesDefaultMigrated), value);
        }
    }
    ...
    public class AdvancedTransitOperationsSettings : SettingsBackup
    {
        public bool AutoOpenSelectionPanel
        {
            get => (bool)GetValue(nameof(AutoOpenSelectionPanel));
            set => SetValue(nameof(AutoOpenSelectionPanel), value);
        }
    }
    ...
    public class AllTransitPlusTrucksSettings : SettingsBackup
    {
        //public bool EnableDebugLogging
        //{
        //    get => (bool)GetValue(nameof(EnableDebugLogging));
        ...
        {
            get => (bool)GetValue(nameof(EnableFullLoadDispatchHelper));
            set => SetValue(nameof(EnableFullLoadDispatchHelper), value);
        }
        ...
        {
            get => (bool)GetValue(nameof(EnableCompanyTruckControl));
            set => SetValue(nameof(EnableCompanyTruckControl), value);
        }
        ...
        {
            get => (float)GetValue(nameof(IndustryMaxTrucksScalar));
            set => SetValue(nameof(IndustryMaxTrucksScalar), value);
        }
        public float WarehouseMaxTrucksScalar
        {
            get => (float)GetValue(nameof(WarehouseMaxTrucksScalar));
            set => SetValue(nameof(WarehouseMaxTrucksScalar), value);
        }
        ...
        public bool ShowServiceFuelRange
        {
            get => (bool)GetValue(nameof(ShowServiceFuelRange));
            set => SetValue(nameof(ShowServiceFuelRange), value);
        }
        public float BusServiceFuelRangeScalar
        {
            get => (float)GetValue(nameof(BusServiceFuelRangeScalar));
            set => SetValue(nameof(BusServiceFuelRangeScalar), value);
        }
        public float TramServiceFuelRangeScalar
        {
            get => (float)GetValue(nameof(TramServiceFuelRangeScalar));
            set => SetValue(nameof(TramServiceFuelRangeScalar), value);
        }
        public float TrainServiceFuelRangeScalar
        {
            get => (float)GetValue(nameof(TrainServiceFuelRangeScalar));
            set => SetValue(nameof(TrainServiceFuelRangeScalar), value);
        }
        public float SubwayServiceFuelRangeScalar
        {
            get => (float)GetValue(nameof(SubwayServiceFuelRangeScalar));
            set => SetValue(nameof(SubwayServiceFuelRangeScalar), value);
        }
        public float BusPassengerScalar
        {
            get => (float)GetValue(nameof(BusPassengerScalar));
    ...
    public class AreaBulldozerSettings : SettingsBackup
    {
        public bool DeleteTrees
        {
            get => (bool)GetValue(nameof(DeleteTrees));
            set => SetValue(nameof(DeleteTrees), value);
        }
        public bool DeleteBuildings
        {
            get => (bool)GetValue(nameof(DeleteBuildings));
            set => SetValue(nameof(DeleteBuildings), value);
        }
        public bool DeleteRoads
        {
            get => (bool)GetValue(nameof(DeleteRoads));
            set => SetValue(nameof(DeleteRoads), value);
        }
        public bool DeletePaths
        {
            get => (bool)GetValue(nameof(DeletePaths));
            set => SetValue(nameof(DeletePaths), value);
        }
        public bool DeleteRailways
        {
            get => (bool)GetValue(nameof(DeleteRailways));
            set => SetValue(nameof(DeleteRailways), value);
        }
        public bool DeleteSurfaces
        {
            get => (bool)GetValue(nameof(DeleteSurfaces));
            set => SetValue(nameof(DeleteSurfaces), value);
        }
        public bool DeleteStaticObjects
        {
            get => (bool)GetValue(nameof(DeleteStaticObjects));
            set => SetValue(nameof(DeleteStaticObjects), value);
        }
        public bool DeleteGeneralProps
        {
            get => (bool)GetValue(nameof(DeleteGeneralProps));
            set => SetValue(nameof(DeleteGeneralProps), value);
        }
        public bool DeleteStreetLights
        {
            get => (bool)GetValue(nameof(DeleteStreetLights));
            set => SetValue(nameof(DeleteStreetLights), value);
        }
        public bool DeleteQuantityObjects
        {
            get => (bool)GetValue(nameof(DeleteQuantityObjects));
            set => SetValue(nameof(DeleteQuantityObjects), value);
        }
        public bool DeleteBrandingObjects
        {
            get => (bool)GetValue(nameof(DeleteBrandingObjects));
            set => SetValue(nameof(DeleteBrandingObjects), value);
        }
        public bool DeleteActivityLocations
        {
            get => (bool)GetValue(nameof(DeleteActivityLocations));
            set => SetValue(nameof(DeleteActivityLocations), value);
        }
        public bool DeleteSpawnLocations
        {
            get => (bool)GetValue(nameof(DeleteSpawnLocations));
            set => SetValue(nameof(DeleteSpawnLocations), value);
        }
        public bool DeleteMarkerNetworks
        {
            get => (bool)GetValue(nameof(DeleteMarkerNetworks));
            set => SetValue(nameof(DeleteMarkerNetworks), value);
        }
        public bool DimMarkerBackground
        {
            get => (bool)GetValue(nameof(DimMarkerBackground));
            set => SetValue(nameof(DimMarkerBackground), value);
        }
        public int MarkerBackgroundDarkness
        {
            get => (int)GetValue(nameof(MarkerBackgroundDarkness));
            set => SetValue(nameof(MarkerBackgroundDarkness), value);
        }
        public bool DeleteBuildingSubObjects
        {
            get => (bool)GetValue(nameof(DeleteBuildingSubObjects));
            set => SetValue(nameof(DeleteBuildingSubObjects), value);
        }
        public bool DeleteNetworkSubObjects
        {
            get => (bool)GetValue(nameof(DeleteNetworkSubObjects));
            set => SetValue(nameof(DeleteNetworkSubObjects), value);
        }
        public bool ProtectOwnedObjects
        {
            get => (bool)GetValue(nameof(ProtectOwnedObjects));
            set => SetValue(nameof(ProtectOwnedObjects), value);
        }
        public int SelectionShape
        {
            get => (int)GetValue(nameof(SelectionShape));
            set => SetValue(nameof(SelectionShape), value);
        }
        public bool UseSquareBrush
        {
            get => (bool)GetValue(nameof(UseSquareBrush));
            set => SetValue(nameof(UseSquareBrush), value);
        }
        public int BrushRadius
        {
            get => (int)GetValue(nameof(BrushRadius));
            set => SetValue(nameof(BrushRadius), value);
        }
        ...
        {
            get => (bool)GetValue(nameof(UseCurvedPolyline));
            set => SetValue(nameof(UseCurvedPolyline), value);
        }
        public int PolylineRounding
        {
            get => (int)GetValue(nameof(PolylineRounding));
            set => SetValue(nameof(PolylineRounding), value);
        }
        public int SelectionLineThickness
        {
            get => (int)GetValue(nameof(SelectionLineThickness));
            set => SetValue(nameof(SelectionLineThickness), value);
        }
        public int UIScale
        {
            get => (int)GetValue(nameof(UIScale));
            set => SetValue(nameof(UIScale), value);
        }
        public int LauncherMode
        {
            get => (int)GetValue(nameof(LauncherMode));
            set => SetValue(nameof(LauncherMode), value);
        }
        ...
        public bool LauncherButtonMovable
        {
            get => (bool)GetValue(nameof(LauncherButtonMovable));
            set => SetValue(nameof(LauncherButtonMovable), value);
        }

        //public int LauncherPositionX
        //{
        //    get => (int)GetValue(nameof(LauncherPositionX));
        //    set => SetValue(nameof(LauncherPositionX), value);
        //}
        //public int LauncherPositionY
        //{
        //    get => (int)GetValue(nameof(LauncherPositionY));
        //    set => SetValue(nameof(LauncherPositionY), value);
        //}
        public bool ConfirmLargeSelection
        {
            get => (bool)GetValue(nameof(ConfirmLargeSelection));
            set => SetValue(nameof(ConfirmLargeSelection), value);
        }
        public int LargeSelectionThreshold
        {
            get => (int)GetValue(nameof(LargeSelectionThreshold));
            set => SetValue(nameof(LargeSelectionThreshold), value);
        }
        //public bool EnableDiagnosticLogging
        //{
        //    get => (bool)GetValue(nameof(EnableDiagnosticLogging));
        //    set => SetValue(nameof(EnableDiagnosticLogging), value);
        //}
    }
    ...
    public class AssetDisablerSettings : SettingsBackup
    {
        public bool Enable_Car01
        {
            get => (bool)GetValue(nameof(Enable_Car01));
            set => SetValue(nameof(Enable_Car01), value);
        }
        public bool Enable_Car02
        {
            get => (bool)GetValue(nameof(Enable_Car02));
            set => SetValue(nameof(Enable_Car02), value);
        }
        public bool Enable_Car03
        {
            get => (bool)GetValue(nameof(Enable_Car03));
            set => SetValue(nameof(Enable_Car03), value);
        }
        public bool Enable_Car04
        {
            get => (bool)GetValue(nameof(Enable_Car04));
            set => SetValue(nameof(Enable_Car04), value);
        }
        public bool Enable_Car05
        {
            get => (bool)GetValue(nameof(Enable_Car05));
            set => SetValue(nameof(Enable_Car05), value);
        }
        public bool Enable_Car06
        {
            get => (bool)GetValue(nameof(Enable_Car06));
            set => SetValue(nameof(Enable_Car06), value);
        }
        public bool Enable_Car07
        {
            get => (bool)GetValue(nameof(Enable_Car07));
            set => SetValue(nameof(Enable_Car07), value);
        }
        public bool Enable_Car08
        {
            get => (bool)GetValue(nameof(Enable_Car08));
            set => SetValue(nameof(Enable_Car08), value);
        }
        public bool Enable_Car09
        {
            get => (bool)GetValue(nameof(Enable_Car09));
            set => SetValue(nameof(Enable_Car09), value);
        }
        public bool Enable_Car10
        {
            get => (bool)GetValue(nameof(Enable_Car10));
            set => SetValue(nameof(Enable_Car10), value);
        }
        public bool Enable_MuscleCar01
        {
            get => (bool)GetValue(nameof(Enable_MuscleCar01));
            set => SetValue(nameof(Enable_MuscleCar01), value);
        }
        public bool Enable_MuscleCar02
        {
            get => (bool)GetValue(nameof(Enable_MuscleCar02));
            set => SetValue(nameof(Enable_MuscleCar02), value);
        }
        public bool Enable_MuscleCar03
        {
            get => (bool)GetValue(nameof(Enable_MuscleCar03));
            set => SetValue(nameof(Enable_MuscleCar03), value);
        }
        public bool Enable_MuscleCar04
        {
            get => (bool)GetValue(nameof(Enable_MuscleCar04));
            set => SetValue(nameof(Enable_MuscleCar04), value);
        }
        public bool Enable_MuscleCar05
        {
            get => (bool)GetValue(nameof(Enable_MuscleCar05));
            set => SetValue(nameof(Enable_MuscleCar05), value);
        }
        public bool Enable_Van01
        {
            get => (bool)GetValue(nameof(Enable_Van01));
            set => SetValue(nameof(Enable_Van01), value);
        }
        public bool Enable_Motorbike01
        {
            get => (bool)GetValue(nameof(Enable_Motorbike01));
            set => SetValue(nameof(Enable_Motorbike01), value);
        }
        public bool Enable_Motorbike02
        {
            get => (bool)GetValue(nameof(Enable_Motorbike02));
            set => SetValue(nameof(Enable_Motorbike02), value);
        }
        public bool Enable_Scooter01
        {
            get => (bool)GetValue(nameof(Enable_Scooter01));
            set => SetValue(nameof(Enable_Scooter01), value);
        }
        public bool Enable_ElectricScooter01
        {
            get => (bool)GetValue(nameof(Enable_ElectricScooter01));
            set => SetValue(nameof(Enable_ElectricScooter01), value);
        }
        public bool Enable_Bicycle01
        {
            get => (bool)GetValue(nameof(Enable_Bicycle01));
            set => SetValue(nameof(Enable_Bicycle01), value);
        }
        public bool Enable_Bicycle02
        {
            get => (bool)GetValue(nameof(Enable_Bicycle02));
            set => SetValue(nameof(Enable_Bicycle02), value);
        }
        public bool Enable_Bicycle03
        {
            get => (bool)GetValue(nameof(Enable_Bicycle03));
            set => SetValue(nameof(Enable_Bicycle03), value);
        }
        public bool Enable_CarTrailer01
        {
            get => (bool)GetValue(nameof(Enable_CarTrailer01));
            set => SetValue(nameof(Enable_CarTrailer01), value);
        }
        public bool Enable_CamperTrailer01
        {
            get => (bool)GetValue(nameof(Enable_CamperTrailer01));
            set => SetValue(nameof(Enable_CamperTrailer01), value);
        }
        public bool Enable_EU_TrainPassengerEngine01
        {
            get => (bool)GetValue(nameof(Enable_EU_TrainPassengerEngine01));
            set => SetValue(nameof(Enable_EU_TrainPassengerEngine01), value);
        }
        public bool Enable_NA_TrainPassengerEngine01
        {
            get => (bool)GetValue(nameof(Enable_NA_TrainPassengerEngine01));
            set => SetValue(nameof(Enable_NA_TrainPassengerEngine01), value);
        }
        public bool Enable_EU_TrainCargoEngine01
        {
            get => (bool)GetValue(nameof(Enable_EU_TrainCargoEngine01));
            set => SetValue(nameof(Enable_EU_TrainCargoEngine01), value);
        }
        public bool Enable_NA_TrainCargoEngine01
        {
            get => (bool)GetValue(nameof(Enable_NA_TrainCargoEngine01));
            set => SetValue(nameof(Enable_NA_TrainCargoEngine01), value);
        }
        public bool Enable_EU_TrainPassengerCar01
        {
            get => (bool)GetValue(nameof(Enable_EU_TrainPassengerCar01));
            set => SetValue(nameof(Enable_EU_TrainPassengerCar01), value);
        }
        public bool Enable_NA_TrainPassengerCar01
        {
            get => (bool)GetValue(nameof(Enable_NA_TrainPassengerCar01));
            set => SetValue(nameof(Enable_NA_TrainPassengerCar01), value);
        }
        public bool Enable_TrainCargoCar01
        {
            get => (bool)GetValue(nameof(Enable_TrainCargoCar01));
            set => SetValue(nameof(Enable_TrainCargoCar01), value);
        }
        public bool Enable_TrainForestryCar01
        {
            get => (bool)GetValue(nameof(Enable_TrainForestryCar01));
            set => SetValue(nameof(Enable_TrainForestryCar01), value);
        }
        public bool Enable_TrainOreCar01
        {
            get => (bool)GetValue(nameof(Enable_TrainOreCar01));
            set => SetValue(nameof(Enable_TrainOreCar01), value);
        }
        public bool Enable_TrainAgricultureCar01
        {
            get => (bool)GetValue(nameof(Enable_TrainAgricultureCar01));
            set => SetValue(nameof(Enable_TrainAgricultureCar01), value);
        }
        public bool Enable_TrainOilCar01
        {
            get => (bool)GetValue(nameof(Enable_TrainOilCar01));
            set => SetValue(nameof(Enable_TrainOilCar01), value);
        }
        public bool Enable_TramEngine01
        {
            get => (bool)GetValue(nameof(Enable_TramEngine01));
            set => SetValue(nameof(Enable_TramEngine01), value);
        }
        public bool Enable_TramEngineCO01
        {
            get => (bool)GetValue(nameof(Enable_TramEngineCO01));
            set => SetValue(nameof(Enable_TramEngineCO01), value);
        }
        public bool Enable_TramCar01
        {
            get => (bool)GetValue(nameof(Enable_TramCar01));
            set => SetValue(nameof(Enable_TramCar01), value);
        }
        public bool Enable_TramCarCO01
        {
            get => (bool)GetValue(nameof(Enable_TramCarCO01));
            set => SetValue(nameof(Enable_TramCarCO01), value);
        }
        public bool Enable_SubwayEngine01
        {
            get => (bool)GetValue(nameof(Enable_SubwayEngine01));
            set => SetValue(nameof(Enable_SubwayEngine01), value);
        }
        public bool Enable_SubwayCar01
        {
            get => (bool)GetValue(nameof(Enable_SubwayCar01));
            set => SetValue(nameof(Enable_SubwayCar01), value);
        }
    }
    ...
    public class AssetIconCreatorSettings : SettingsBackup
    {
        ...
        //{
        //    get => (bool)GetValue(nameof(CameraDebug));
        //    set => SetValue(nameof(CameraDebug), value);
        //}
    ...
    public class AssetMenuTweaksSettings : SettingsBackup
    {
        public int Density
        {
            get => (int)GetValue(nameof(Density));
            set => SetValue(nameof(Density), value);
        }
        public bool RedesignedTabs
        {
            get => (bool)GetValue(nameof(RedesignedTabs));
            set => SetValue(nameof(RedesignedTabs), value);
        }
        public bool Widescreen
        {
            get => (bool)GetValue(nameof(Widescreen));
            set => SetValue(nameof(Widescreen), value);
        }
        public bool HideBadges
        {
            get => (bool)GetValue(nameof(HideBadges));
            set => SetValue(nameof(HideBadges), value);
        }
    }
    ...
    public class AssetMigrationUtilitySettings : SettingsBackup
    {
        ...
        //public bool PerObjectLogging
        //{
        //    get => (bool)GetValue(nameof(PerObjectLogging));
        //    set => SetValue(nameof(PerObjectLogging), value);
        //}
    }
    ...
    public class AutoBulldozerSettings : SettingsBackup
    {
        ...
        public bool DemolishAbandoned
        {
            get => (bool)GetValue(nameof(DemolishAbandoned));
            set => SetValue(nameof(DemolishAbandoned), value);
        }
        public bool DemolishCondemned
        {
            get => (bool)GetValue(nameof(DemolishCondemned));
            set => SetValue(nameof(DemolishCondemned), value);
        }
        public bool DemolishDestroyed
        {
            get => (bool)GetValue(nameof(DemolishDestroyed));
            set => SetValue(nameof(DemolishDestroyed), value);
        }
        public int AbandonedGraceDays
        {
            get => (int)GetValue(nameof(AbandonedGraceDays));
            set => SetValue(nameof(AbandonedGraceDays), value);
        }
        public int SweepsPerDay
        {
            get => (int)GetValue(nameof(SweepsPerDay));
            set => SetValue(nameof(SweepsPerDay), value);
        }
    }
    ...
    public class AutoNightLODExtenderSettings : SettingsBackup
    {
        public bool EnableAdaptiveLod
        {
            get => (bool)GetValue(nameof(EnableAdaptiveLod));
            set => SetValue(nameof(EnableAdaptiveLod), value);
        }
        public int AdaptiveResponseSpeed
        {
            get => (int)GetValue(nameof(AdaptiveResponseSpeed));
            set => SetValue(nameof(AdaptiveResponseSpeed), value);
        }
        public int TargetFps
        {
            get => (int)GetValue(nameof(TargetFps));
            set => SetValue(nameof(TargetFps), value);
        }
        public float MinAdaptiveLod
        {
            get => (float)GetValue(nameof(MinAdaptiveLod));
            set => SetValue(nameof(MinAdaptiveLod), value);
        }
        public float MaxAdaptiveLod
        {
            get => (float)GetValue(nameof(MaxAdaptiveLod));
            set => SetValue(nameof(MaxAdaptiveLod), value);
        }
        public bool EnableStillCameraStabilization
        {
            get => (bool)GetValue(nameof(EnableStillCameraStabilization));
            set => SetValue(nameof(EnableStillCameraStabilization), value);
        }
        public bool EnableNightLodMultiplier
        {
            get => (bool)GetValue(nameof(EnableNightLodMultiplier));
            set => SetValue(nameof(EnableNightLodMultiplier), value);
        }
        public float NightLodMultiplier
        {
            get => (float)GetValue(nameof(NightLodMultiplier));
            set => SetValue(nameof(NightLodMultiplier), value);
        }
        public int NightMaxLightCount
        {
            get => (int)GetValue(nameof(NightMaxLightCount));
            set => SetValue(nameof(NightMaxLightCount), value);
        }
    }
    ...
    public class BetterEducationInfoviewSettings : SettingsBackup
    {
        public bool OverlayEnabled
        {
            get => (bool)GetValue(nameof(OverlayEnabled));
            set => SetValue(nameof(OverlayEnabled), value);
        }
        public bool HideEmptySchools
        {
            get => (bool)GetValue(nameof(HideEmptySchools));
            set => SetValue(nameof(HideEmptySchools), value);
        }
        public int OverlayScale
        {
            get => (int)GetValue(nameof(OverlayScale));
            set => SetValue(nameof(OverlayScale), value);
        }
        public int YellowThreshold
        {
            get => (int)GetValue(nameof(YellowThreshold));
            set => SetValue(nameof(YellowThreshold), value);
        }
        public int RedThreshold
        {
            get => (int)GetValue(nameof(RedThreshold));
            set => SetValue(nameof(RedThreshold), value);
        }
    }
    ...
    public class BikesPlusPathsSettings : SettingsBackup
    {
        public bool EnableBikesAndPaths
        {
            get => (bool)GetValue(nameof(EnableBikesAndPaths));
            set => SetValue(nameof(EnableBikesAndPaths), value);
        }
    ...
    public class BitulaModSettings : SettingsBackup
    {
        public string JobSeekerMilestoneText
        {
            get => (string)GetValue(nameof(JobSeekerMilestoneText));
            set => SetValue(nameof(JobSeekerMilestoneText), value);
        }
        public int JobSeekerFailureIncrement
        {
            get => (int)GetValue(nameof(JobSeekerFailureIncrement));
            set => SetValue(nameof(JobSeekerFailureIncrement), value);
        }
        public bool PrioritizeAdultEmployment
        {
            get => (bool)GetValue(nameof(PrioritizeAdultEmployment));
            set => SetValue(nameof(PrioritizeAdultEmployment), value);
        }
        public bool AcceptLowerJobs
        {
            get => (bool)GetValue(nameof(AcceptLowerJobs));
            set => SetValue(nameof(AcceptLowerJobs), value);
        }
        public bool AcceptJobSwitch
        {
            get => (bool)GetValue(nameof(AcceptJobSwitch));
            set => SetValue(nameof(AcceptJobSwitch), value);
        }
    }
    ...
    public class BridgeTheLanguageGapSettings : SettingsBackup
    {
        public bool Enabled
        {
        ...
        public bool ScopeModOptions
        {
            get => (bool)GetValue(nameof(ScopeModOptions));
            set => SetValue(nameof(ScopeModOptions), value);
        }
        public bool ScopeAssetNames
        {
            get => (bool)GetValue(nameof(ScopeAssetNames));
            set => SetValue(nameof(ScopeAssetNames), value);
        }
        public bool ScopeAssetDescriptions
        {
            get => (bool)GetValue(nameof(ScopeAssetDescriptions));
            set => SetValue(nameof(ScopeAssetDescriptions), value);
        }
        public bool ScopeGameCore
        {
            get => (bool)GetValue(nameof(ScopeGameCore));
            set => SetValue(nameof(ScopeGameCore), value);
        }
        public bool ScopeModName
        {
            get => (bool)GetValue(nameof(ScopeModName));
            set => SetValue(nameof(ScopeModName), value);
        }
        public bool ScopeWorldLabels
        {
            get => (bool)GetValue(nameof(ScopeWorldLabels));
            set => SetValue(nameof(ScopeWorldLabels), value);
        }
        public string TargetLocale
        {
            get => (string)GetValue(nameof(TargetLocale));
            set => SetValue(nameof(TargetLocale), value);
        }
        public int TranslationEngine
        {
            get => (int)GetValue(nameof(TranslationEngine));
            set => SetValue(nameof(TranslationEngine), value);
        }
        public string MicrosoftKey
        {
            get => (string)GetValue(nameof(MicrosoftKey));
            set => SetValue(nameof(MicrosoftKey), value);
        }
        public string MicrosoftRegion
        {
            get => (string)GetValue(nameof(MicrosoftRegion));
            set => SetValue(nameof(MicrosoftRegion), value);
        }
        public string DeepLKey
        {
            get => (string)GetValue(nameof(DeepLKey));
            set => SetValue(nameof(DeepLKey), value);
        }
        public string BaiduAppId
        {
            get => (string)GetValue(nameof(BaiduAppId));
            set => SetValue(nameof(BaiduAppId), value);
        }
        public string BaiduKey
        {
            get => (string)GetValue(nameof(BaiduKey));
            set => SetValue(nameof(BaiduKey), value);
        }
    }
    ...
    public class BuildingReviverSettings : SettingsBackup
    {
        public bool EnableMod
        {
            get => (bool)GetValue(nameof(EnableMod));
        ...
        public bool ReviveAbandoned
        {
            get => (bool)GetValue(nameof(ReviveAbandoned));
            set => SetValue(nameof(ReviveAbandoned), value);
        }
        public int SweepsPerDay
        {
            get => (int)GetValue(nameof(SweepsPerDay));
    ...
    public class BulldozerMarqueeSettings : SettingsBackup
    {
        public bool ConfirmBulldoze
        {
            get => (bool)GetValue(nameof(ConfirmBulldoze));
            set => SetValue(nameof(ConfirmBulldoze), value);
        }
        public bool PruneOnFilterChange
        {
            get => (bool)GetValue(nameof(PruneOnFilterChange));
            set => SetValue(nameof(PruneOnFilterChange), value);
        }
        public bool PlaySfx
        {
            get => (bool)GetValue(nameof(PlaySfx));
            set => SetValue(nameof(PlaySfx), value);
        }
        public int SavedFilters
        {
            get => (int)GetValue(nameof(SavedFilters));
            set => SetValue(nameof(SavedFilters), value);
        }
    }
    ...
    public class CemeteryOverflowManagerSettings : SettingsBackup
    {
        public bool EnableMod
        {
            get => (bool)GetValue(nameof(EnableMod));
        ...
        public bool EnableSoftScaling
        {
            get => (bool)GetValue(nameof(EnableSoftScaling));
            set => SetValue(nameof(EnableSoftScaling), value);
        }
        public int BacklogThreshold
        {
            get => (int)GetValue(nameof(BacklogThreshold));
            set => SetValue(nameof(BacklogThreshold), value);
        }
        public int ScaleFactor
        {
            get => (int)GetValue(nameof(ScaleFactor));
            set => SetValue(nameof(ScaleFactor), value);
        }
        public bool EnableHardCleanup
        {
            get => (bool)GetValue(nameof(EnableHardCleanup));
            set => SetValue(nameof(EnableHardCleanup), value);
        }
        public int CleanupGraceDays
        {
            get => (int)GetValue(nameof(CleanupGraceDays));
            set => SetValue(nameof(CleanupGraceDays), value);
        }
        public int SweepsPerDay
        {
            get => (int)GetValue(nameof(SweepsPerDay));
    ...
    public class CityMonitorSettings : SettingsBackup
    {
        public string UiState
        {
            get => (string)GetValue(nameof(UiState));
            set => SetValue(nameof(UiState), value);
        }
        public string HiddenIcons
        {
            get => (string)GetValue(nameof(HiddenIcons));
            set => SetValue(nameof(HiddenIcons), value);
        }
        public string IconOrder
        {
            get => (string)GetValue(nameof(IconOrder));
            set => SetValue(nameof(IconOrder), value);
        }
        public bool ShowPanel
        {
            get => (bool)GetValue(nameof(ShowPanel));
            set => SetValue(nameof(ShowPanel), value);
        }
        public bool CompactValues
        {
            get => (bool)GetValue(nameof(CompactValues));
            set => SetValue(nameof(CompactValues), value);
        }
        public bool ShowLabels
        {
            get => (bool)GetValue(nameof(ShowLabels));
            set => SetValue(nameof(ShowLabels), value);
        }
        public bool IconOnlyMode
        {
            get => (bool)GetValue(nameof(IconOnlyMode));
            set => SetValue(nameof(IconOnlyMode), value);
        }
        public int IconOrientation
        {
            get => (int)GetValue(nameof(IconOrientation));
            set => SetValue(nameof(IconOrientation), value);
        }

        //public bool IconPositionLocked
        //{
        //    get => (bool)GetValue(nameof(IconPositionLocked));
        //    set => SetValue(nameof(IconPositionLocked), value);
        //}
        public bool IconVisibilityEditMode
        {
            get => (bool)GetValue(nameof(IconVisibilityEditMode));
            set => SetValue(nameof(IconVisibilityEditMode), value);
        }
        public int IconBackgroundTransparency
        {
            get => (int)GetValue(nameof(IconBackgroundTransparency));
            set => SetValue(nameof(IconBackgroundTransparency), value);
        }
        public int IconSize
        {
            get => (int)GetValue(nameof(IconSize));
            set => SetValue(nameof(IconSize), value);
        }
        public int IconGap
        {
            get => (int)GetValue(nameof(IconGap));
            set => SetValue(nameof(IconGap), value);
        }
        public float UpdateIntervalSeconds
        {
            get => (float)GetValue(nameof(UpdateIntervalSeconds));
    ...
    public class CitySoundsSettings : SettingsBackup
    {
        public string LevelCrossingSound
        {
            get => (string)GetValue(nameof(LevelCrossingSound));
            set => SetValue(nameof(LevelCrossingSound), value);
        }
        public string FireAlarmSound
        {
            get => (string)GetValue(nameof(FireAlarmSound));
            set => SetValue(nameof(FireAlarmSound), value);
        }
        public string TrainBrakingSound
        {
            get => (string)GetValue(nameof(TrainBrakingSound));
            set => SetValue(nameof(TrainBrakingSound), value);
        }
        public int LevelCrossingVolume
        {
            get => (int)GetValue(nameof(LevelCrossingVolume));
            set => SetValue(nameof(LevelCrossingVolume), value);
        }
        public int FireAlarmVolume
        {
            get => (int)GetValue(nameof(FireAlarmVolume));
            set => SetValue(nameof(FireAlarmVolume), value);
        }
        public int TrainDoorVolume
        {
            get => (int)GetValue(nameof(TrainDoorVolume));
            set => SetValue(nameof(TrainDoorVolume), value);
        }
        public int TrainBrakingVolume
        {
            get => (int)GetValue(nameof(TrainBrakingVolume));
            set => SetValue(nameof(TrainBrakingVolume), value);
        }
        public int CarHornVolume
        {
            get => (int)GetValue(nameof(CarHornVolume));
            set => SetValue(nameof(CarHornVolume), value);
        }
        public int WindTurbineVolume
        {
            get => (int)GetValue(nameof(WindTurbineVolume));
            set => SetValue(nameof(WindTurbineVolume), value);
        }
    }
    ...
    public class CityWatchdogSettings : SettingsBackup
    {
        ...
        public bool PanelButtonsOnlyStart
        {
            get => (bool)GetValue(nameof(PanelButtonsOnlyStart));
            set => SetValue(nameof(PanelButtonsOnlyStart), value);
        }
        public int MainPanelOpacity
        {
            get => (int)GetValue(nameof(MainPanelOpacity));
            set => SetValue(nameof(MainPanelOpacity), value);
        }
        public bool InterfaceScaling
        {
            get => (bool)GetValue(nameof(InterfaceScaling));
            set => SetValue(nameof(InterfaceScaling), value);
        }
        ...
        //{
        //    get => (int)GetValue(nameof(PanelPositionX));
        //    set => SetValue(nameof(PanelPositionX), value);
        //}
        //public int PanelPositionY
        //{
        //    get => (int)GetValue(nameof(PanelPositionY));
        //    set => SetValue(nameof(PanelPositionY), value);
        //}
        //public int EditorQuickControlsPositionX
        //{
        //    get => (int)GetValue(nameof(EditorQuickControlsPositionX));
        //    set => SetValue(nameof(EditorQuickControlsPositionX), value);
        //}
        //public int EditorQuickControlsPositionY
        //{
        //    get => (int)GetValue(nameof(EditorQuickControlsPositionY));
        //    set => SetValue(nameof(EditorQuickControlsPositionY), value);
        //}
        public int PanelCollapsedSectionsMask
        {
            get => (int)GetValue(nameof(PanelCollapsedSectionsMask));
            set => SetValue(nameof(PanelCollapsedSectionsMask), value);
        }
        public int PanelSortMode
        {
            get => (int)GetValue(nameof(PanelSortMode));
            set => SetValue(nameof(PanelSortMode), value);
        }
        public bool MiniHudEnabled
        {
            get => (bool)GetValue(nameof(MiniHudEnabled));
            set => SetValue(nameof(MiniHudEnabled), value);
        }
        public int MiniHudMode
        {
            get => (int)GetValue(nameof(MiniHudMode));
            set => SetValue(nameof(MiniHudMode), value);
        }
        public int MiniHudItemCount
        {
            get => (int)GetValue(nameof(MiniHudItemCount));
            set => SetValue(nameof(MiniHudItemCount), value);
        }
        public bool MiniHudHideZero
        {
            get => (bool)GetValue(nameof(MiniHudHideZero));
            set => SetValue(nameof(MiniHudHideZero), value);
        }
        public int MiniHudScale
        {
            get => (int)GetValue(nameof(MiniHudScale));
            set => SetValue(nameof(MiniHudScale), value);
        }
        public int MiniHudOrientation
        {
            get => (int)GetValue(nameof(MiniHudOrientation));
            set => SetValue(nameof(MiniHudOrientation), value);
        }
        public int MiniHudPlacement
        {
            get => (int)GetValue(nameof(MiniHudPlacement));
            set => SetValue(nameof(MiniHudPlacement), value);
        }
        public int MiniHudPanelStyle
        {
            get => (int)GetValue(nameof(MiniHudPanelStyle));
            set => SetValue(nameof(MiniHudPanelStyle), value);
        }
        public int MiniHudPanelOpacity
        {
            get => (int)GetValue(nameof(MiniHudPanelOpacity));
            set => SetValue(nameof(MiniHudPanelOpacity), value);
        }
        public bool MiniHudGlassStyle
        {
            get => (bool)GetValue(nameof(MiniHudGlassStyle));
            set => SetValue(nameof(MiniHudGlassStyle), value);
        }
        public int MiniHudFavoriteMaskLow
        {
            get => (int)GetValue(nameof(MiniHudFavoriteMaskLow));
            set => SetValue(nameof(MiniHudFavoriteMaskLow), value);
        }
        public int MiniHudFavoriteMaskHigh
        {
            get => (int)GetValue(nameof(MiniHudFavoriteMaskHigh));
            set => SetValue(nameof(MiniHudFavoriteMaskHigh), value);
        }

        //public int MiniHudPositionX
        //{
        //    get => (int)GetValue(nameof(MiniHudPositionX));
        //    set => SetValue(nameof(MiniHudPositionX), value);
        //}
        //public int MiniHudPositionY
        //{
        //    get => (int)GetValue(nameof(MiniHudPositionY));
        //    set => SetValue(nameof(MiniHudPositionY), value);
        //}
        //public int MiniHudPositionOrientation
        //{
        //    get => (int)GetValue(nameof(MiniHudPositionOrientation));
        //    set => SetValue(nameof(MiniHudPositionOrientation), value);
        //}
        //public int MiniHudHorizontalPositionX
        //{
        //    get => (int)GetValue(nameof(MiniHudHorizontalPositionX));
        //    set => SetValue(nameof(MiniHudHorizontalPositionX), value);
        //}
        //public int MiniHudHorizontalPositionY
        //{
        //    get => (int)GetValue(nameof(MiniHudHorizontalPositionY));
        //    set => SetValue(nameof(MiniHudHorizontalPositionY), value);
        //}
        //public int MiniHudVerticalPositionX
        //{
        //    get => (int)GetValue(nameof(MiniHudVerticalPositionX));
        //    set => SetValue(nameof(MiniHudVerticalPositionX), value);
        //}
        //public int MiniHudVerticalPositionY
        //{
        //    get => (int)GetValue(nameof(MiniHudVerticalPositionY));
        //    set => SetValue(nameof(MiniHudVerticalPositionY), value);
        //}
        ...
        public bool BuildingLevelingNotification
        {
            get => (bool)GetValue(nameof(BuildingLevelingNotification));
            set => SetValue(nameof(BuildingLevelingNotification), value);
        }
        public bool TrafficBottleneckNotification
        {
            get => (bool)GetValue(nameof(TrafficBottleneckNotification));
    ...
    public class CivicVoiceSettings : SettingsBackup
    {
        ...
        {
            get => (bool)GetValue(nameof(ShowNewsTicker));
            set => SetValue(nameof(ShowNewsTicker), value);
        }
        public int Theme
        {
            get => (int)GetValue(nameof(Theme));
        ...
        public int HousingProposalCooldownMonths
        {
            get => (int)GetValue(nameof(HousingProposalCooldownMonths));
            set => SetValue(nameof(HousingProposalCooldownMonths), value);
        }
        public int UrgentProjectApprovalWeight
        {
            get => (int)GetValue(nameof(UrgentProjectApprovalWeight));
            set => SetValue(nameof(UrgentProjectApprovalWeight), value);
        }
        public int AdHocProjectApprovalWeight
        {
            get => (int)GetValue(nameof(AdHocProjectApprovalWeight));
            set => SetValue(nameof(AdHocProjectApprovalWeight), value);
        }
        public int MajorProjectApprovalWeight
        {
            get => (int)GetValue(nameof(MajorProjectApprovalWeight));
            set => SetValue(nameof(MajorProjectApprovalWeight), value);
        }
        ...
        {
            get => (bool)GetValue(nameof(ClearHistory));
            set => SetValue(nameof(ClearHistory), value);
        }
    }
    ...
    public class CollisionBeGoneSettings : SettingsBackup
    {
        ...
        public bool ClipBicycles
        {
            get => (bool)GetValue(nameof(ClipBicycles));
            set => SetValue(nameof(ClipBicycles), value);
        }
        public bool IgnoreBicycles
        {
            get => (bool)GetValue(nameof(IgnoreBicycles));
            set => SetValue(nameof(IgnoreBicycles), value);
        }
        public bool IgnorePedestrians
        {
            get => (bool)GetValue(nameof(IgnorePedestrians));
            set => SetValue(nameof(IgnorePedestrians), value);
        }
        public bool ParkingReservation
        {
            get => (bool)GetValue(nameof(ParkingReservation));
            set => SetValue(nameof(ParkingReservation), value);
        }
        //public bool DiagnosticsLogging
        //{
        //    get => (bool)GetValue(nameof(DiagnosticsLogging));
        //    set => SetValue(nameof(DiagnosticsLogging), value);
        //}
    }
    ...
    public class ConcurrentBusBoardingSettings : SettingsBackup
    {
        public int SettingsVersion
        {
            get => (int)GetValue(nameof(SettingsVersion));
            set => SetValue(nameof(SettingsVersion), value);
        }
        public bool EnableConcurrentBoarding
        {
            get => (bool)GetValue(nameof(EnableConcurrentBoarding));
            set => SetValue(nameof(EnableConcurrentBoarding), value);
        }
        public int PublicTransportAttractiveness
        {
            get => (int)GetValue(nameof(PublicTransportAttractiveness));
            set => SetValue(nameof(PublicTransportAttractiveness), value);
        }
        public int BusAttractiveness
        {
            get => (int)GetValue(nameof(BusAttractiveness));
            set => SetValue(nameof(BusAttractiveness), value);
        }
        public int DefaultZoneLength
        {
            get => (int)GetValue(nameof(DefaultZoneLength));
            set => SetValue(nameof(DefaultZoneLength), value);
        }
        public bool OnlyShowSelectedStop
        {
            get => (bool)GetValue(nameof(OnlyShowSelectedStop));
            set => SetValue(nameof(OnlyShowSelectedStop), value);
        }
        public int GlobalOverlayRed
        {
            get => (int)GetValue(nameof(GlobalOverlayRed));
            set => SetValue(nameof(GlobalOverlayRed), value);
        }
        public int GlobalOverlayGreen
        {
            get => (int)GetValue(nameof(GlobalOverlayGreen));
            set => SetValue(nameof(GlobalOverlayGreen), value);
        }
        public int GlobalOverlayBlue
        {
            get => (int)GetValue(nameof(GlobalOverlayBlue));
            set => SetValue(nameof(GlobalOverlayBlue), value);
        }
        public int GlobalOverlayAlpha
        {
            get => (int)GetValue(nameof(GlobalOverlayAlpha));
            set => SetValue(nameof(GlobalOverlayAlpha), value);
        }
        public int OverlayOpacity
        {
            get => (int)GetValue(nameof(OverlayOpacity));
            set => SetValue(nameof(OverlayOpacity), value);
        }
    }
    ...
    public class CopasteSettings : SettingsBackup
    {
        public int ModLanguage
        {
            get => (int)GetValue(nameof(ModLanguage));
            set => SetValue(nameof(ModLanguage), value);
        }
        public bool AnarchyPaste
        {
            get => (bool)GetValue(nameof(AnarchyPaste));
            set => SetValue(nameof(AnarchyPaste), value);
        }
        public int PanelTheme
        {
            get => (int)GetValue(nameof(PanelTheme));
            set => SetValue(nameof(PanelTheme), value);
        }
        public int PanelScale
        {
            get => (int)GetValue(nameof(PanelScale));
            set => SetValue(nameof(PanelScale), value);
        }
        public int TextScale
        {
            get => (int)GetValue(nameof(TextScale));
            set => SetValue(nameof(TextScale), value);
        }
        public int MaxSelection
        {
            get => (int)GetValue(nameof(MaxSelection));
            set => SetValue(nameof(MaxSelection), value);
        }
        public int MaxOverlayShapes
        {
            get => (int)GetValue(nameof(MaxOverlayShapes));
            set => SetValue(nameof(MaxOverlayShapes), value);
        }
        public int SelectionListMax
        {
            get => (int)GetValue(nameof(SelectionListMax));
            set => SetValue(nameof(SelectionListMax), value);
        }
        public int PanelX
        {
            get => (int)GetValue(nameof(PanelX));
            set => SetValue(nameof(PanelX), value);
        }
        public int PanelY
        {
            get => (int)GetValue(nameof(PanelY));
            set => SetValue(nameof(PanelY), value);
        }
        public bool RandomPasteVariation
        {
            get => (bool)GetValue(nameof(RandomPasteVariation));
            set => SetValue(nameof(RandomPasteVariation), value);
        }
        public bool SelectProps
        {
            get => (bool)GetValue(nameof(SelectProps));
            set => SetValue(nameof(SelectProps), value);
        }
        public bool SelectTrees
        {
            get => (bool)GetValue(nameof(SelectTrees));
            set => SetValue(nameof(SelectTrees), value);
        }
        public bool SelectDecals
        {
            get => (bool)GetValue(nameof(SelectDecals));
            set => SetValue(nameof(SelectDecals), value);
        }
        public bool SelectSurfaces
        {
            get => (bool)GetValue(nameof(SelectSurfaces));
            set => SetValue(nameof(SelectSurfaces), value);
        }
        public bool SelectBuildings
        {
            get => (bool)GetValue(nameof(SelectBuildings));
            set => SetValue(nameof(SelectBuildings), value);
        }
        public bool SelectFences
        {
            get => (bool)GetValue(nameof(SelectFences));
            set => SetValue(nameof(SelectFences), value);
        }
        public bool SelectNetworks
        {
            get => (bool)GetValue(nameof(SelectNetworks));
            set => SetValue(nameof(SelectNetworks), value);
        }
        public bool RoadSnapPaste
        {
            get => (bool)GetValue(nameof(RoadSnapPaste));
            set => SetValue(nameof(RoadSnapPaste), value);
        }
        public bool SelectBuildingProps
        {
            get => (bool)GetValue(nameof(SelectBuildingProps));
            set => SetValue(nameof(SelectBuildingProps), value);
        }
    }

    public class CrashRepairSettings : SettingsBackup
    {
        public bool AutoRepairOnLoad
        {
            get => (bool)GetValue(nameof(AutoRepairOnLoad));
            set => SetValue(nameof(AutoRepairOnLoad), value);
        }
        public bool AdvancedCleanup
        {
            get => (bool)GetValue(nameof(AdvancedCleanup));
            set => SetValue(nameof(AdvancedCleanup), value);
        }
    }
    ...
    public class CustomLandParcelSettings : SettingsBackup
    {
        public bool EnableVanillaMapTileCompatibility
        {
            get => (bool)GetValue(nameof(EnableVanillaMapTileCompatibility));
            set => SetValue(nameof(EnableVanillaMapTileCompatibility), value);
        }
        public bool ShowVanillaUnlockedMapTileBorders
        {
            get => (bool)GetValue(nameof(ShowVanillaUnlockedMapTileBorders));
            set => SetValue(nameof(ShowVanillaUnlockedMapTileBorders), value);
        }
        public int ParcelBoundaryRed
        {
            get => (int)GetValue(nameof(ParcelBoundaryRed));
            set => SetValue(nameof(ParcelBoundaryRed), value);
        }
        public int ParcelBoundaryGreen
        {
            get => (int)GetValue(nameof(ParcelBoundaryGreen));
            set => SetValue(nameof(ParcelBoundaryGreen), value);
        }
        public int ParcelBoundaryBlue
        {
            get => (int)GetValue(nameof(ParcelBoundaryBlue));
            set => SetValue(nameof(ParcelBoundaryBlue), value);
        }
        public int ParcelBoundaryOpacity
        {
            get => (int)GetValue(nameof(ParcelBoundaryOpacity));
            set => SetValue(nameof(ParcelBoundaryOpacity), value);
        }
        public int ParcelFillOpacity
        {
            get => (int)GetValue(nameof(ParcelFillOpacity));
            set => SetValue(nameof(ParcelFillOpacity), value);
        }
        public int ParcelBoundaryWidth
        {
            get => (int)GetValue(nameof(ParcelBoundaryWidth));
            set => SetValue(nameof(ParcelBoundaryWidth), value);
        }
        public bool EnablePlacementDiagnostics
        {
            get => (bool)GetValue(nameof(EnablePlacementDiagnostics));
            set => SetValue(nameof(EnablePlacementDiagnostics), value);
        }
    }
    ...
    public class DedicatedCargoFacilitiesSettings : SettingsBackup
    {
        public bool EnableDedicatedFacilities
        {
            get => (bool)GetValue(nameof(EnableDedicatedFacilities));
            set => SetValue(nameof(EnableDedicatedFacilities), value);
        }
        public bool EnableFacilityDiagnostics
        {
            get => (bool)GetValue(nameof(EnableFacilityDiagnostics));
            set => SetValue(nameof(EnableFacilityDiagnostics), value);
        }
        public int MediumTrainCoalYardProfile
        {
            get => (int)GetValue(nameof(MediumTrainCoalYardProfile));
            set => SetValue(nameof(MediumTrainCoalYardProfile), value);
        }
        public int MediumTrainAgriYardsProfile
        {
            get => (int)GetValue(nameof(MediumTrainAgriYardsProfile));
            set => SetValue(nameof(MediumTrainAgriYardsProfile), value);
        }
        public int MediumTrainLumberYardsProfile
        {
            get => (int)GetValue(nameof(MediumTrainLumberYardsProfile));
            set => SetValue(nameof(MediumTrainLumberYardsProfile), value);
        }
        public int MediumTrainOilYardsProfile
        {
            get => (int)GetValue(nameof(MediumTrainOilYardsProfile));
            set => SetValue(nameof(MediumTrainOilYardsProfile), value);
        }
        public int MiniTrainOilStationsProfile
        {
            get => (int)GetValue(nameof(MiniTrainOilStationsProfile));
            set => SetValue(nameof(MiniTrainOilStationsProfile), value);
        }
        public int MediumTrainGarbageYardsProfile
        {
            get => (int)GetValue(nameof(MediumTrainGarbageYardsProfile));
            set => SetValue(nameof(MediumTrainGarbageYardsProfile), value);
        }
    }
    ...
    public class DimThatHighlightSettings : SettingsBackup
    {
        public int ColorRgb
        {
            get => (int)GetValue(nameof(ColorRgb));
            set => SetValue(nameof(ColorRgb), value);
        }
        public int StrengthPercent
        {
            get => (int)GetValue(nameof(StrengthPercent));
            set => SetValue(nameof(StrengthPercent), value);
        }
        public int WidthPercent
        {
            get => (int)GetValue(nameof(WidthPercent));
            set => SetValue(nameof(WidthPercent), value);
        }
    }
    ...
    public class DistrictGroupsSettings : SettingsBackup
    {
        public bool OverlayEnableGroupLabels
        {
            get => (bool)GetValue(nameof(OverlayEnableGroupLabels));
            set => SetValue(nameof(OverlayEnableGroupLabels), value);
        }
        public int OverlayDesaturationPercent
        {
            get => (int)GetValue(nameof(OverlayDesaturationPercent));
            set => SetValue(nameof(OverlayDesaturationPercent), value);
        }
        public int OverlayBorderTransparency
        {
            get => (int)GetValue(nameof(OverlayBorderTransparency));
            set => SetValue(nameof(OverlayBorderTransparency), value);
        }
        public int OverlayBorderWidth
        {
            get => (int)GetValue(nameof(OverlayBorderWidth));
            set => SetValue(nameof(OverlayBorderWidth), value);
        }
        public bool OverlayFillUseTransparency
        {
            get => (bool)GetValue(nameof(OverlayFillUseTransparency));
            set => SetValue(nameof(OverlayFillUseTransparency), value);
        }
        public int OverlayFillSaturationPercent
        {
            get => (int)GetValue(nameof(OverlayFillSaturationPercent));
            set => SetValue(nameof(OverlayFillSaturationPercent), value);
        }
        public int RefreshRateSeconds
        {
            get => (int)GetValue(nameof(RefreshRateSeconds));
            set => SetValue(nameof(RefreshRateSeconds), value);
        }
        //public bool EnableDebugLogging
        //{
        //    get => (bool)GetValue(nameof(EnableDebugLogging));
    ...
    public class DistrictHeightPolicySettings : SettingsBackup
    {
        public float SmallMin
        {
            get => (float)GetValue(nameof(SmallMin));
            set => SetValue(nameof(SmallMin), value);
        }
        public float SmallMax
        {
            get => (float)GetValue(nameof(SmallMax));
            set => SetValue(nameof(SmallMax), value);
        }
        public float MediumMin
        {
            get => (float)GetValue(nameof(MediumMin));
            set => SetValue(nameof(MediumMin), value);
        }
        public float MediumMax
        {
            get => (float)GetValue(nameof(MediumMax));
            set => SetValue(nameof(MediumMax), value);
        }
        public float LargeMin
        {
            get => (float)GetValue(nameof(LargeMin));
            set => SetValue(nameof(LargeMin), value);
        }
        public float LargeMax
        {
            get => (float)GetValue(nameof(LargeMax));
            set => SetValue(nameof(LargeMax), value);
        }
        public float TallMin
        {
            get => (float)GetValue(nameof(TallMin));
            set => SetValue(nameof(TallMin), value);
        }
        public float TallMax
        {
            get => (float)GetValue(nameof(TallMax));
            set => SetValue(nameof(TallMax), value);
        }
        public float SuperTallMin
        {
            get => (float)GetValue(nameof(SuperTallMin));
            set => SetValue(nameof(SuperTallMin), value);
        }
        public float SuperTallMax
        {
            get => (float)GetValue(nameof(SuperTallMax));
            set => SetValue(nameof(SuperTallMax), value);
        }
        public float SkyscraperMin
        {
            get => (float)GetValue(nameof(SkyscraperMin));
            set => SetValue(nameof(SkyscraperMin), value);
        }
        public float SkyscraperMax
        {
            get => (float)GetValue(nameof(SkyscraperMax));
            set => SetValue(nameof(SkyscraperMax), value);
        }
        public int MaxRerolls
        {
            get => (int)GetValue(nameof(MaxRerolls));
            set => SetValue(nameof(MaxRerolls), value);
        }
        public int Fallback
        {
            get => (int)GetValue(nameof(Fallback));
            set => SetValue(nameof(Fallback), value);
        }
        public bool EnablePlatterIntegration
        {
            get => (bool)GetValue(nameof(EnablePlatterIntegration));
            set => SetValue(nameof(EnablePlatterIntegration), value);
        }
    }
    ...
    public class EconomyEXSettings : SettingsBackup
    {
        ...
        public int FindHomeCandidateCap
        {
            get => (int)GetValue(nameof(FindHomeCandidateCap));
            set => SetValue(nameof(FindHomeCandidateCap), value);
        }
        ...
        //}
        public string GhostVehicleScanData
        {
            get => (string)GetValue(nameof(GhostVehicleScanData));
            set => SetValue(nameof(GhostVehicleScanData), value);
        }
    }
    ...
    public class EmergencyPrioritySettings : SettingsBackup
    {
        public bool Enabled
        {
            get => (bool)GetValue(nameof(Enabled));
        ...
        public bool DespawnGuard
        {
            get => (bool)GetValue(nameof(DespawnGuard));
            set => SetValue(nameof(DespawnGuard), value);
        }
        public bool AutoReroute
        {
            get => (bool)GetValue(nameof(AutoReroute));
            set => SetValue(nameof(AutoReroute), value);
        }
        public int RerouteAfterSeconds
        {
            get => (int)GetValue(nameof(RerouteAfterSeconds));
            set => SetValue(nameof(RerouteAfterSeconds), value);
        }
        public bool GreenLightPriority
        {
            get => (bool)GetValue(nameof(GreenLightPriority));
            set => SetValue(nameof(GreenLightPriority), value);
        }
        public int GreenLightDistance
        {
            get => (int)GetValue(nameof(GreenLightDistance));
            set => SetValue(nameof(GreenLightDistance), value);
        }
    }
    ...
    public class FertilityControlSettings : SettingsBackup
    {
        ...
        public float FishPercentPerDay
        {
            get => (float)GetValue(nameof(FishPercentPerDay));
            set => SetValue(nameof(FishPercentPerDay), value);
        }
    ...
    public class GrassSpritesSettings : SettingsBackup
    {
        public bool Enabled
        {
            get => (bool)GetValue(nameof(Enabled));
        ...
        {
            get => (int)GetValue(nameof(MaskResolution));
            set => SetValue(nameof(MaskResolution), value);
        }
        public string SelectedExportMaskFile
        {
            get => (string)GetValue(nameof(SelectedExportMaskFile));
            set => SetValue(nameof(SelectedExportMaskFile), value);
        }
        public bool BrushToolActive
        {
            get => (bool)GetValue(nameof(BrushToolActive));
            set => SetValue(nameof(BrushToolActive), value);
        }
        public bool BrushPanelVisible
        {
            get => (bool)GetValue(nameof(BrushPanelVisible));
            set => SetValue(nameof(BrushPanelVisible), value);
        }
        public bool PrecisionDabMode
        {
            get => (bool)GetValue(nameof(PrecisionDabMode));
            set => SetValue(nameof(PrecisionDabMode), value);
        }
        public float PaintRadiusMeters
        {
            get => (float)GetValue(nameof(PaintRadiusMeters));
            set => SetValue(nameof(PaintRadiusMeters), value);
        }
        //public float2 BrushPanelPosition
        //{
        //    get => (float2)GetValue(nameof(BrushPanelPosition));
        //    set => SetValue(nameof(BrushPanelPosition), value);
        //}
    }

    public class GridRoadGeneratorSettings : SettingsBackup
    {
        public int Mode
        {
            get => (int)GetValue(nameof(Mode));
            set => SetValue(nameof(Mode), value);
        }
        public int Columns
        {
            get => (int)GetValue(nameof(Columns));
            set => SetValue(nameof(Columns), value);
        }
        public int Rows
        {
            get => (int)GetValue(nameof(Rows));
            set => SetValue(nameof(Rows), value);
        }
        public float SpacingMeters
        {
            get => (float)GetValue(nameof(SpacingMeters));
            set => SetValue(nameof(SpacingMeters), value);
        }
        public float AngleOffsetDegrees
        {
            get => (float)GetValue(nameof(AngleOffsetDegrees));
            set => SetValue(nameof(AngleOffsetDegrees), value);
        }
        public bool FollowTerrain
        {
            get => (bool)GetValue(nameof(FollowTerrain));
            set => SetValue(nameof(FollowTerrain), value);
        }
        public bool CulDeSacMode
        {
            get => (bool)GetValue(nameof(CulDeSacMode));
            set => SetValue(nameof(CulDeSacMode), value);
        }
        public int CulDeSacAxis
        {
            get => (int)GetValue(nameof(CulDeSacAxis));
            set => SetValue(nameof(CulDeSacAxis), value);
        }
        public float CulDeSacDepth
        {
            get => (float)GetValue(nameof(CulDeSacDepth));
            set => SetValue(nameof(CulDeSacDepth), value);
        }
        public bool Staggered
        {
            get => (bool)GetValue(nameof(Staggered));
            set => SetValue(nameof(Staggered), value);
        }
        public float CulDeSacRatio
        {
            get => (float)GetValue(nameof(CulDeSacRatio));
            set => SetValue(nameof(CulDeSacRatio), value);
        }
        public int CulDeSacCapSize
        {
            get => (int)GetValue(nameof(CulDeSacCapSize));
            set => SetValue(nameof(CulDeSacCapSize), value);
        }
        public int CulDeSacCapStyle
        {
            get => (int)GetValue(nameof(CulDeSacCapStyle));
            set => SetValue(nameof(CulDeSacCapStyle), value);
        }
        public bool AvenueColumnEnabled
        {
            get => (bool)GetValue(nameof(AvenueColumnEnabled));
            set => SetValue(nameof(AvenueColumnEnabled), value);
        }
        public int AvenueColumnIndex
        {
            get => (int)GetValue(nameof(AvenueColumnIndex));
            set => SetValue(nameof(AvenueColumnIndex), value);
        }
        public bool AvenueRowEnabled
        {
            get => (bool)GetValue(nameof(AvenueRowEnabled));
            set => SetValue(nameof(AvenueRowEnabled), value);
        }
        public int AvenueRowIndex
        {
            get => (int)GetValue(nameof(AvenueRowIndex));
            set => SetValue(nameof(AvenueRowIndex), value);
        }
        public bool AdaptiveMode
        {
            get => (bool)GetValue(nameof(AdaptiveMode));
            set => SetValue(nameof(AdaptiveMode), value);
        }
        public int RadialConnections
        {
            get => (int)GetValue(nameof(RadialConnections));
            set => SetValue(nameof(RadialConnections), value);
        }
        public string RoadPrefabName
        {
            get => (string)GetValue(nameof(RoadPrefabName));
            set => SetValue(nameof(RoadPrefabName), value);
        }
        public string SecondaryRoadPrefabName
        {
            get => (string)GetValue(nameof(SecondaryRoadPrefabName));
            set => SetValue(nameof(SecondaryRoadPrefabName), value);
        }
        public string AvenueRoadPrefabName
        {
            get => (string)GetValue(nameof(AvenueRoadPrefabName));
            set => SetValue(nameof(AvenueRoadPrefabName), value);
        }
        public int SelectedViews
        {
            get => (int)GetValue(nameof(SelectedViews));
            set => SetValue(nameof(SelectedViews), value);
        }
    }
    ...
    public class HallOfFameSettings : SettingsBackup
    {
        ...
        {
            get => (string)GetValue(nameof(PublicCreatorID));
            set => SetValue(nameof(PublicCreatorID), value);
        }
        ...
        public bool HasSeenWebViewerDialog
        {
            get => (bool)GetValue(nameof(HasSeenWebViewerDialog));
            set => SetValue(nameof(HasSeenWebViewerDialog), value);
        }
    ...
    public class HardModeContinuedSettings : SettingsBackup
    {
        ...
        public bool TerraformingCostsMoney
        {
            get => (bool)GetValue(nameof(TerraformingCostsMoney));
            set => SetValue(nameof(TerraformingCostsMoney), value);
        }
        ...
        public bool DefaultBlock
        {
            get => (bool)GetValue(nameof(DefaultBlock));
            set => SetValue(nameof(DefaultBlock), value);
        }
    }
    ...
    public class HistoricalToolSettings : SettingsBackup
    {
        public int ButtonPosition
        {
            get => (int)GetValue(nameof(ButtonPosition));
            set => SetValue(nameof(ButtonPosition), value);
        }
    }
    ...
    public class HoverColorsSettings : SettingsBackup
    {
        ...
        public bool PresetSetsInitialized
        {
            get => (bool)GetValue(nameof(PresetSetsInitialized));
            set => SetValue(nameof(PresetSetsInitialized), value);
        }
        public int ActivePresetSet
        {
            get => (int)GetValue(nameof(ActivePresetSet));
            set => SetValue(nameof(ActivePresetSet), value);
        }
        public float PresetAlt1R
        {
            get => (float)GetValue(nameof(PresetAlt1R));
            set => SetValue(nameof(PresetAlt1R), value);
        }
        public float PresetAlt1G
        {
            get => (float)GetValue(nameof(PresetAlt1G));
            set => SetValue(nameof(PresetAlt1G), value);
        }
        public float PresetAlt1B
        {
            get => (float)GetValue(nameof(PresetAlt1B));
            set => SetValue(nameof(PresetAlt1B), value);
        }
        public float PresetAlt1A
        {
            get => (float)GetValue(nameof(PresetAlt1A));
            set => SetValue(nameof(PresetAlt1A), value);
        }
        public float PresetAlt1FillA
        {
            get => (float)GetValue(nameof(PresetAlt1FillA));
            set => SetValue(nameof(PresetAlt1FillA), value);
        }
        public int PresetAlt1GuidelinePercent
        {
            get => (int)GetValue(nameof(PresetAlt1GuidelinePercent));
            set => SetValue(nameof(PresetAlt1GuidelinePercent), value);
        }
        public float PresetAlt2R
        {
            get => (float)GetValue(nameof(PresetAlt2R));
            set => SetValue(nameof(PresetAlt2R), value);
        }
        public float PresetAlt2G
        {
            get => (float)GetValue(nameof(PresetAlt2G));
            set => SetValue(nameof(PresetAlt2G), value);
        }
        public float PresetAlt2B
        {
            get => (float)GetValue(nameof(PresetAlt2B));
            set => SetValue(nameof(PresetAlt2B), value);
        }
        public float PresetAlt2A
        {
            get => (float)GetValue(nameof(PresetAlt2A));
            set => SetValue(nameof(PresetAlt2A), value);
        }
        public float PresetAlt2FillA
        {
            get => (float)GetValue(nameof(PresetAlt2FillA));
            set => SetValue(nameof(PresetAlt2FillA), value);
        }
        public int PresetAlt2GuidelinePercent
        {
            get => (int)GetValue(nameof(PresetAlt2GuidelinePercent));
            set => SetValue(nameof(PresetAlt2GuidelinePercent), value);
        }
        public bool PresetDefaultsToggleActive
        {
            get => (bool)GetValue(nameof(PresetDefaultsToggleActive));
            set => SetValue(nameof(PresetDefaultsToggleActive), value);
        }
        public bool PresetDefaultsToggleHasBackup
        {
            get => (bool)GetValue(nameof(PresetDefaultsToggleHasBackup));
            set => SetValue(nameof(PresetDefaultsToggleHasBackup), value);
        }
        public int PresetDefaultsBackupActiveSet
        {
            get => (int)GetValue(nameof(PresetDefaultsBackupActiveSet));
            set => SetValue(nameof(PresetDefaultsBackupActiveSet), value);
        }
        public float PresetDefaultsBackup1R
        {
            get => (float)GetValue(nameof(PresetDefaultsBackup1R));
            set => SetValue(nameof(PresetDefaultsBackup1R), value);
        }
        public float PresetDefaultsBackup1G
        {
            get => (float)GetValue(nameof(PresetDefaultsBackup1G));
            set => SetValue(nameof(PresetDefaultsBackup1G), value);
        }
        public float PresetDefaultsBackup1B
        {
            get => (float)GetValue(nameof(PresetDefaultsBackup1B));
            set => SetValue(nameof(PresetDefaultsBackup1B), value);
        }
        public float PresetDefaultsBackup1A
        {
            get => (float)GetValue(nameof(PresetDefaultsBackup1A));
            set => SetValue(nameof(PresetDefaultsBackup1A), value);
        }
        public float PresetDefaultsBackup1FillA
        {
            get => (float)GetValue(nameof(PresetDefaultsBackup1FillA));
            set => SetValue(nameof(PresetDefaultsBackup1FillA), value);
        }
        public int PresetDefaultsBackup1GuidelinePercent
        {
            get => (int)GetValue(nameof(PresetDefaultsBackup1GuidelinePercent));
            set => SetValue(nameof(PresetDefaultsBackup1GuidelinePercent), value);
        }
        public float PresetDefaultsBackup2R
        {
            get => (float)GetValue(nameof(PresetDefaultsBackup2R));
            set => SetValue(nameof(PresetDefaultsBackup2R), value);
        }
        public float PresetDefaultsBackup2G
        {
            get => (float)GetValue(nameof(PresetDefaultsBackup2G));
            set => SetValue(nameof(PresetDefaultsBackup2G), value);
        }
        public float PresetDefaultsBackup2B
        {
            get => (float)GetValue(nameof(PresetDefaultsBackup2B));
            set => SetValue(nameof(PresetDefaultsBackup2B), value);
        }
        public float PresetDefaultsBackup2A
        {
            get => (float)GetValue(nameof(PresetDefaultsBackup2A));
            set => SetValue(nameof(PresetDefaultsBackup2A), value);
        }
        public float PresetDefaultsBackup2FillA
        {
            get => (float)GetValue(nameof(PresetDefaultsBackup2FillA));
            set => SetValue(nameof(PresetDefaultsBackup2FillA), value);
        }
        public int PresetDefaultsBackup2GuidelinePercent
        {
            get => (int)GetValue(nameof(PresetDefaultsBackup2GuidelinePercent));
            set => SetValue(nameof(PresetDefaultsBackup2GuidelinePercent), value);
        }
        public float PresetDefaultsBackupAlt1R
        {
            get => (float)GetValue(nameof(PresetDefaultsBackupAlt1R));
            set => SetValue(nameof(PresetDefaultsBackupAlt1R), value);
        }
        public float PresetDefaultsBackupAlt1G
        {
            get => (float)GetValue(nameof(PresetDefaultsBackupAlt1G));
            set => SetValue(nameof(PresetDefaultsBackupAlt1G), value);
        }
        public float PresetDefaultsBackupAlt1B
        {
            get => (float)GetValue(nameof(PresetDefaultsBackupAlt1B));
            set => SetValue(nameof(PresetDefaultsBackupAlt1B), value);
        }
        public float PresetDefaultsBackupAlt1A
        {
            get => (float)GetValue(nameof(PresetDefaultsBackupAlt1A));
            set => SetValue(nameof(PresetDefaultsBackupAlt1A), value);
        }
        public float PresetDefaultsBackupAlt1FillA
        {
            get => (float)GetValue(nameof(PresetDefaultsBackupAlt1FillA));
            set => SetValue(nameof(PresetDefaultsBackupAlt1FillA), value);
        }
        public int PresetDefaultsBackupAlt1GuidelinePercent
        {
            get => (int)GetValue(nameof(PresetDefaultsBackupAlt1GuidelinePercent));
            set => SetValue(nameof(PresetDefaultsBackupAlt1GuidelinePercent), value);
        }
        public float PresetDefaultsBackupAlt2R
        {
            get => (float)GetValue(nameof(PresetDefaultsBackupAlt2R));
            set => SetValue(nameof(PresetDefaultsBackupAlt2R), value);
        }
        public float PresetDefaultsBackupAlt2G
        {
            get => (float)GetValue(nameof(PresetDefaultsBackupAlt2G));
            set => SetValue(nameof(PresetDefaultsBackupAlt2G), value);
        }
        public float PresetDefaultsBackupAlt2B
        {
            get => (float)GetValue(nameof(PresetDefaultsBackupAlt2B));
            set => SetValue(nameof(PresetDefaultsBackupAlt2B), value);
        }
        public float PresetDefaultsBackupAlt2A
        {
            get => (float)GetValue(nameof(PresetDefaultsBackupAlt2A));
            set => SetValue(nameof(PresetDefaultsBackupAlt2A), value);
        }
        public float PresetDefaultsBackupAlt2FillA
        {
            get => (float)GetValue(nameof(PresetDefaultsBackupAlt2FillA));
            set => SetValue(nameof(PresetDefaultsBackupAlt2FillA), value);
        }
        public int PresetDefaultsBackupAlt2GuidelinePercent
        {
            get => (int)GetValue(nameof(PresetDefaultsBackupAlt2GuidelinePercent));
            set => SetValue(nameof(PresetDefaultsBackupAlt2GuidelinePercent), value);
        }
        ...
        {
            get => (bool)GetValue(nameof(PanelCollapsed));
            set => SetValue(nameof(PanelCollapsed), value);
        }
    ...
    public class ImageOverlaySettings : SettingsBackup
    {
        ...
        {
            get => (bool)GetValue(nameof(TerrainConforming));
            set => SetValue(nameof(TerrainConforming), value);
        }
        public int MeshResolution
        {
            get => (int)GetValue(nameof(MeshResolution));
            set => SetValue(nameof(MeshResolution), value);
        }
    ...
    public class IntelligentCommoditySchedulingSettings : SettingsBackup
    {
        ...
        public int CargoStationBalance
        {
            get => (int)GetValue(nameof(CargoStationBalance));
            set => SetValue(nameof(CargoStationBalance), value);
        }
        public bool ExperimentalCommercialRecovery
        {
            get => (bool)GetValue(nameof(ExperimentalCommercialRecovery));
            set => SetValue(nameof(ExperimentalCommercialRecovery), value);
        }

        //public int LogLevel
        //{
        //    get => (int)GetValue(nameof(LogLevel));
        //    set => SetValue(nameof(LogLevel), value);
        //}
    ...
    public class LocalLogisticsSettings : SettingsBackup
    {
        public bool Enabled
        {
            get => (bool)GetValue(nameof(Enabled));
        ...
        {
            get => (bool)GetValue(nameof(StrictMode));
            set => SetValue(nameof(StrictMode), value);
        }
    }
    ...
    public class LuminaSettings : SettingsBackup
    {
        ...
        public bool NGXMode
        {
            get => (bool)GetValue(nameof(NGXMode));
            set => SetValue(nameof(NGXMode), value);
        }
        ...
        {
            get => (bool)GetValue(nameof(HideToolbarButton));
            set => SetValue(nameof(HideToolbarButton), value);
        }
    ...
    public class MagicHearseSettings : SettingsBackup
    {
        ...
        {
            get => (bool)GetValue(nameof(MagicResetCemetery));
            set => SetValue(nameof(MagicResetCemetery), value);
        }
        ...
        {
            get => (bool)GetValue(nameof(AutoResetCemetery));
            set => SetValue(nameof(AutoResetCemetery), value);
        }
        public int HearseWarningMinutes
        {
            get => (int)GetValue(nameof(HearseWarningMinutes));
            set => SetValue(nameof(HearseWarningMinutes), value);
        }
        ...
        public int CemeteryTurnoverScalar
        {
            get => (int)GetValue(nameof(CemeteryTurnoverScalar));
            set => SetValue(nameof(CemeteryTurnoverScalar), value);
        }
    ...
    public class MapExtSettings : SettingsBackup
    {
        ...
        public bool TerrainDownsampleThrottle
        {
            get => (bool)GetValue(nameof(TerrainDownsampleThrottle));
            set => SetValue(nameof(TerrainDownsampleThrottle), value);
        }
        ...
        {
            get => (bool)GetValue(nameof(WaterAsyncCompute));
            set => SetValue(nameof(WaterAsyncCompute), value);
        }
        public bool WaterPauseFreeze
        {
            get => (bool)GetValue(nameof(WaterPauseFreeze));
            set => SetValue(nameof(WaterPauseFreeze), value);
        }
        public int SnowSimFreeze
        {
            get => (int)GetValue(nameof(SnowSimFreeze));
            set => SetValue(nameof(SnowSimFreeze), value);
        }
        ...
        public int ResourceSellerCandidateCap
        {
            get => (int)GetValue(nameof(ResourceSellerCandidateCap));
            set => SetValue(nameof(ResourceSellerCandidateCap), value);
        }
        public int LeisureCandidateCap
        {
            get => (int)GetValue(nameof(LeisureCandidateCap));
            set => SetValue(nameof(LeisureCandidateCap), value);
        }
        public int FindHomeCandidateCap
        {
            get => (int)GetValue(nameof(FindHomeCandidateCap));
    ...
    public class MapTextureReplacerSettings : SettingsBackup
    {
        ...
        public string TilingFloatData
        {
            get => (string)GetValue(nameof(TilingFloatData));
            set => SetValue(nameof(TilingFloatData), value);
        }
    ...
    public class MertsToolBoxSettings : SettingsBackup
    {
        public bool SuppressCrosswalks
        {
            get => (bool)GetValue(nameof(SuppressCrosswalks));
            set => SetValue(nameof(SuppressCrosswalks), value);
        }
        public int DefaultShapeDimension
        {
            get => (int)GetValue(nameof(DefaultShapeDimension));
            set => SetValue(nameof(DefaultShapeDimension), value);
        }
        public bool UseCtrlWheelForShapeDimensionAdjustment
        {
            get => (bool)GetValue(nameof(UseCtrlWheelForShapeDimensionAdjustment));
            set => SetValue(nameof(UseCtrlWheelForShapeDimensionAdjustment), value);
        }
        public int DefaultHelixDiameter
        {
            get => (int)GetValue(nameof(DefaultHelixDiameter));
            set => SetValue(nameof(DefaultHelixDiameter), value);
        }
        public float DefaultTurns
        {
            get => (float)GetValue(nameof(DefaultTurns));
            set => SetValue(nameof(DefaultTurns), value);
        }
        public float DefaultClearance
        {
            get => (float)GetValue(nameof(DefaultClearance));
            set => SetValue(nameof(DefaultClearance), value);
        }
        public bool UseCtrlWheelForHelixTurnAdjustment
        {
            get => (bool)GetValue(nameof(UseCtrlWheelForHelixTurnAdjustment));
            set => SetValue(nameof(UseCtrlWheelForHelixTurnAdjustment), value);
        }
        public int DefaultSoftBlockWidth
        {
            get => (int)GetValue(nameof(DefaultSoftBlockWidth));
            set => SetValue(nameof(DefaultSoftBlockWidth), value);
        }
        public int DefaultSoftBlockLength
        {
            get => (int)GetValue(nameof(DefaultSoftBlockLength));
            set => SetValue(nameof(DefaultSoftBlockLength), value);
        }
        public float DefaultSoftBlockBorderRadius
        {
            get => (float)GetValue(nameof(DefaultSoftBlockBorderRadius));
            set => SetValue(nameof(DefaultSoftBlockBorderRadius), value);
        }
        public bool UseCtrlWheelForSoftBlockBorderRadius
        {
            get => (bool)GetValue(nameof(UseCtrlWheelForSoftBlockBorderRadius));
            set => SetValue(nameof(UseCtrlWheelForSoftBlockBorderRadius), value);
        }
        public int DefaultBlockWidthU
        {
            get => (int)GetValue(nameof(DefaultBlockWidthU));
            set => SetValue(nameof(DefaultBlockWidthU), value);
        }
        public int DefaultBlockLengthU
        {
            get => (int)GetValue(nameof(DefaultBlockLengthU));
            set => SetValue(nameof(DefaultBlockLengthU), value);
        }
        public int DefaultColumns
        {
            get => (int)GetValue(nameof(DefaultColumns));
            set => SetValue(nameof(DefaultColumns), value);
        }
        public int DefaultRows
        {
            get => (int)GetValue(nameof(DefaultRows));
            set => SetValue(nameof(DefaultRows), value);
        }
    }

    public class MeshStatsViewerSettings : SettingsBackup
    {
        public bool EnableVanilla
        {
            get => (bool)GetValue(nameof(EnableVanilla));
            set => SetValue(nameof(EnableVanilla), value);
        }
        public int ViewChooser
        {
            get => (int)GetValue(nameof(ViewChooser));
            set => SetValue(nameof(ViewChooser), value);
        }
        public int LOD1Threshold
        {
            get => (int)GetValue(nameof(LOD1Threshold));
            set => SetValue(nameof(LOD1Threshold), value);
        }
        public int LOD2Threshold
        {
            get => (int)GetValue(nameof(LOD2Threshold));
            set => SetValue(nameof(LOD2Threshold), value);
        }
        public int TrisThreshold
        {
            get => (int)GetValue(nameof(TrisThreshold));
            set => SetValue(nameof(TrisThreshold), value);
        }
        public int VolumeThreshold
        {
            get => (int)GetValue(nameof(VolumeThreshold));
            set => SetValue(nameof(VolumeThreshold), value);
        }
        public bool CheekyMode
        {
            get => (bool)GetValue(nameof(CheekyMode));
            set => SetValue(nameof(CheekyMode), value);
        }
    }

    public class MetroDiagramSettings : SettingsBackup
    {
        public string InterfaceLanguage
        {
            get => (string)GetValue(nameof(InterfaceLanguage));
            set => SetValue(nameof(InterfaceLanguage), value);
        }
        public string InstalledVersion
        {
            get => (string)GetValue(nameof(InstalledVersion));
            set => SetValue(nameof(InstalledVersion), value);
        }
        public string ExportDirectory
        {
            get => (string)GetValue(nameof(ExportDirectory));
            set => SetValue(nameof(ExportDirectory), value);
        }
        public string InGamePreviewLayout
        {
            get => (string)GetValue(nameof(InGamePreviewLayout));
            set => SetValue(nameof(InGamePreviewLayout), value);
        }
        public bool InGamePreviewGeographicDefaultApplied
        {
            get => (bool)GetValue(nameof(InGamePreviewGeographicDefaultApplied));
            set => SetValue(nameof(InGamePreviewGeographicDefaultApplied), value);
        }
        public bool InGamePreviewShowGenericStationNames
        {
            get => (bool)GetValue(nameof(InGamePreviewShowGenericStationNames));
            set => SetValue(nameof(InGamePreviewShowGenericStationNames), value);
        }
        public bool InGamePreviewHideCrowdedLabels
        {
            get => (bool)GetValue(nameof(InGamePreviewHideCrowdedLabels));
            set => SetValue(nameof(InGamePreviewHideCrowdedLabels), value);
        }
        public bool ExportPassengerIntercityRailDevelopment
        {
            get => (bool)GetValue(nameof(ExportPassengerIntercityRailDevelopment));
            set => SetValue(nameof(ExportPassengerIntercityRailDevelopment), value);
        }
    }
    ...
    public class NaturalRegrowthSettings : SettingsBackup
    {
        public int ReproductionRate
        {
            get => (int)GetValue(nameof(ReproductionRate));
            set => SetValue(nameof(ReproductionRate), value);
        }
        public int LocalDensityCap
        {
            get => (int)GetValue(nameof(LocalDensityCap));
            set => SetValue(nameof(LocalDensityCap), value);
        }
        public int SpawnRadius
        {
            get => (int)GetValue(nameof(SpawnRadius));
            set => SetValue(nameof(SpawnRadius), value);
        }
        public int GrowthRate
        {
            get => (int)GetValue(nameof(GrowthRate));
            set => SetValue(nameof(GrowthRate), value);
        }
    }
    ...
    public class NodeControllerSettings : SettingsBackup
    {
        ...
        public bool EnableScrollWheelFreeForm
        {
            get => (bool)GetValue(nameof(EnableScrollWheelFreeForm));
            set => SetValue(nameof(EnableScrollWheelFreeForm), value);
        }
        public bool DisableBindings
        {
            get => (bool)GetValue(nameof(DisableBindings));
            set => SetValue(nameof(DisableBindings), value);
        }
        public int ButtonPosition
        {
            get => (int)GetValue(nameof(ButtonPosition));
        ...
        public int ScrollWheelRotationAnglePositive
        {
            get => (int)GetValue(nameof(ScrollWheelRotationAnglePositive));
            set => SetValue(nameof(ScrollWheelRotationAnglePositive), value);
        }
        public int ScrollWheelRotationAngleNegative
        {
            get => (int)GetValue(nameof(ScrollWheelRotationAngleNegative));
            set => SetValue(nameof(ScrollWheelRotationAngleNegative), value);
        }
        public int ScrollWheelVerticalPositiveIncrement
        {
            get => (int)GetValue(nameof(ScrollWheelVerticalPositiveIncrement));
            set => SetValue(nameof(ScrollWheelVerticalPositiveIncrement), value);
        }
        public int ScrollWheelVerticalNegativeIncrement
        {
            get => (int)GetValue(nameof(ScrollWheelVerticalNegativeIncrement));
            set => SetValue(nameof(ScrollWheelVerticalNegativeIncrement), value);
        }
        public int ScrollWheelYPositiveIncrement
        {
            get => (int)GetValue(nameof(ScrollWheelYPositiveIncrement));
            set => SetValue(nameof(ScrollWheelYPositiveIncrement), value);
        }
        public int ScrollWheelYNegativeIncrement
        {
            get => (int)GetValue(nameof(ScrollWheelYNegativeIncrement));
            set => SetValue(nameof(ScrollWheelYNegativeIncrement), value);
        }
        public int ScrollWheelXPositiveIncrement
        {
            get => (int)GetValue(nameof(ScrollWheelXPositiveIncrement));
            set => SetValue(nameof(ScrollWheelXPositiveIncrement), value);
        }
        public int ScrollWheelXNegativeIncrement
        {
            get => (int)GetValue(nameof(ScrollWheelXNegativeIncrement));
            set => SetValue(nameof(ScrollWheelXNegativeIncrement), value);
        }
    }

    public class NoMoreSignsSettings : SettingsBackup
    {
        public bool HideSigns
        {
            get => (bool)GetValue(nameof(HideSigns));
            set => SetValue(nameof(HideSigns), value);
        }
        public bool HideTrafficLights
        {
            get => (bool)GetValue(nameof(HideTrafficLights));
            set => SetValue(nameof(HideTrafficLights), value);
        }
        public bool HideStreetLights
        {
            get => (bool)GetValue(nameof(HideStreetLights));
            set => SetValue(nameof(HideStreetLights), value);
        }
        public bool HideProps
        {
            get => (bool)GetValue(nameof(HideProps));
            set => SetValue(nameof(HideProps), value);
        }
        public bool HideSpeedMarkings
        {
            get => (bool)GetValue(nameof(HideSpeedMarkings));
            set => SetValue(nameof(HideSpeedMarkings), value);
        }
        public bool HideRoadArrows
        {
            get => (bool)GetValue(nameof(HideRoadArrows));
            set => SetValue(nameof(HideRoadArrows), value);
        }
        public bool HighwayHideSigns
        {
            get => (bool)GetValue(nameof(HighwayHideSigns));
            set => SetValue(nameof(HighwayHideSigns), value);
        }
        public bool HighwayHideTrafficLights
        {
            get => (bool)GetValue(nameof(HighwayHideTrafficLights));
            set => SetValue(nameof(HighwayHideTrafficLights), value);
        }
        public bool HighwayHideStreetLights
        {
            get => (bool)GetValue(nameof(HighwayHideStreetLights));
            set => SetValue(nameof(HighwayHideStreetLights), value);
        }
        public bool HighwayHideProps
        {
            get => (bool)GetValue(nameof(HighwayHideProps));
            set => SetValue(nameof(HighwayHideProps), value);
        }
        public bool HighwayHideSpeedMarkings
        {
            get => (bool)GetValue(nameof(HighwayHideSpeedMarkings));
            set => SetValue(nameof(HighwayHideSpeedMarkings), value);
        }
        public bool HighwayHideRoadArrows
        {
            get => (bool)GetValue(nameof(HighwayHideRoadArrows));
            set => SetValue(nameof(HighwayHideRoadArrows), value);
        }
    }
    ...
    public class NoSpeedLimitMarkingDecalsSettings : SettingsBackup
    {
        public bool HideSpeedLimitMarkings
        {
            get => (bool)GetValue(nameof(HideSpeedLimitMarkings));
            set => SetValue(nameof(HideSpeedLimitMarkings), value);
        }
        //public bool DetailedLogging
        //{
        //    get => (bool)GetValue(nameof(DetailedLogging));
        //    set => SetValue(nameof(DetailedLogging), value);
        //}
    }
    ...
    public class NoVehicleDespawnSettings : SettingsBackup
    {
        ...
        public bool removeBlockerOnly
        {
            get => (bool)GetValue(nameof(removeBlockerOnly));
            set => SetValue(nameof(removeBlockerOnly), value);
        }
    ...
    public class ParkingControlSettings : SettingsBackup
    {
        public int Scope
        {
            get => (int)GetValue(nameof(Scope));
            set => SetValue(nameof(Scope), value);
        }
        public bool ShowInstructions
        {
            get => (bool)GetValue(nameof(ShowInstructions));
            set => SetValue(nameof(ShowInstructions), value);
        }
        public bool ShowStatus
        {
            get => (bool)GetValue(nameof(ShowStatus));
            set => SetValue(nameof(ShowStatus), value);
        }
        //public bool VerboseLog
        //{
        //    get => (bool)GetValue(nameof(VerboseLog));
        //    set => SetValue(nameof(VerboseLog), value);
        //}
    }
    ...
    public class PaulovsRentModSettings : SettingsBackup
    {
        public bool ModEnabled
        {
            get => (bool)GetValue(nameof(ModEnabled));
        ...
        {
            get => (float)GetValue(nameof(RentMultiplier));
            set => SetValue(nameof(RentMultiplier), value);
        }
    }

    public class PaulovsUKEconomySettings : SettingsBackup
    {
        public bool Toggle
        {
        ...
        {
            get => (int)GetValue(nameof(IntSlider));
            set => SetValue(nameof(IntSlider), value);
        }
        public int IntDropdown
        {
            get => (int)GetValue(nameof(IntDropdown));
            set => SetValue(nameof(IntDropdown), value);
        }
        public int EnumDropdown
        {
            get => (int)GetValue(nameof(EnumDropdown));
    ...
    public class PinboardSettings : SettingsBackup
    {
        public string SelectedCollectionId
        {
            get => (string)GetValue(nameof(SelectedCollectionId));
            set => SetValue(nameof(SelectedCollectionId), value);
        }
        public string SelectedFilterId
        {
            get => (string)GetValue(nameof(SelectedFilterId));
            set => SetValue(nameof(SelectedFilterId), value);
        }
    }

    public class PlanboardSettings : SettingsBackup
    {
        public bool UseVanillaToolBindings
        {
            get => (bool)GetValue(nameof(UseVanillaToolBindings));
            set => SetValue(nameof(UseVanillaToolBindings), value);
        }
        public bool ShowCompletedMarkers
        {
            get => (bool)GetValue(nameof(ShowCompletedMarkers));
            set => SetValue(nameof(ShowCompletedMarkers), value);
        }
        public bool ShowAllTitles
        {
            get => (bool)GetValue(nameof(ShowAllTitles));
            set => SetValue(nameof(ShowAllTitles), value);
        }
        public string DeadlineMode
        {
            get => (string)GetValue(nameof(DeadlineMode));
            set => SetValue(nameof(DeadlineMode), value);
        }
        public string DateFormat
        {
            get => (string)GetValue(nameof(DateFormat));
            set => SetValue(nameof(DateFormat), value);
        }
        public string ToolbarLocation
        {
            get => (string)GetValue(nameof(ToolbarLocation));
            set => SetValue(nameof(ToolbarLocation), value);
        }
        public int WindowLayoutRevision
        {
            get => (int)GetValue(nameof(WindowLayoutRevision));
            set => SetValue(nameof(WindowLayoutRevision), value);
        }
    }
    ...
    public class PlopShuffleSettings : SettingsBackup
    {
        public bool UseUniversalModMenu
        {
            get => (bool)GetValue(nameof(UseUniversalModMenu));
    ...
    public class PriceAdjusterSettings : SettingsBackup
    {
        public bool HasSeenWelcome
        {
            get => (bool)GetValue(nameof(HasSeenWelcome));
            set => SetValue(nameof(HasSeenWelcome), value);
        }
        public bool ForceRecalculatePricesButton
        {
            get => (bool)GetValue(nameof(ForceRecalculatePricesButton));
            set => SetValue(nameof(ForceRecalculatePricesButton), value);
        }
        public int Preset
        {
            get => (int)GetValue(nameof(Preset));
        ...
        {
            get => (float)GetValue(nameof(RoadPriceMultiplier));
            set => SetValue(nameof(RoadPriceMultiplier), value);
        }
        public float HighwayPriceMultiplier
        {
            get => (float)GetValue(nameof(HighwayPriceMultiplier));
            set => SetValue(nameof(HighwayPriceMultiplier), value);
        }
        public float RoundaboutPriceMultiplier
        {
            get => (float)GetValue(nameof(RoundaboutPriceMultiplier));
            set => SetValue(nameof(RoundaboutPriceMultiplier), value);
        }
        public float TrainTrackPriceMultiplier
        {
            get => (float)GetValue(nameof(TrainTrackPriceMultiplier));
            set => SetValue(nameof(TrainTrackPriceMultiplier), value);
        }
        public float TramTrackPriceMultiplier
        {
            get => (float)GetValue(nameof(TramTrackPriceMultiplier));
            set => SetValue(nameof(TramTrackPriceMultiplier), value);
        }
        public float SubwayTrackPriceMultiplier
        {
            get => (float)GetValue(nameof(SubwayTrackPriceMultiplier));
            set => SetValue(nameof(SubwayTrackPriceMultiplier), value);
        }
        public float LowVoltagePriceMultiplier
        {
            get => (float)GetValue(nameof(LowVoltagePriceMultiplier));
            set => SetValue(nameof(LowVoltagePriceMultiplier), value);
        }
        public float HighVoltagePriceMultiplier
        {
            get => (float)GetValue(nameof(HighVoltagePriceMultiplier));
            set => SetValue(nameof(HighVoltagePriceMultiplier), value);
        }
        public float WaterPriceMultiplier
        {
            get => (float)GetValue(nameof(WaterPriceMultiplier));
            set => SetValue(nameof(WaterPriceMultiplier), value);
        }
        public float SewagePriceMultiplier
        {
            get => (float)GetValue(nameof(SewagePriceMultiplier));
            set => SetValue(nameof(SewagePriceMultiplier), value);
        }
        public bool ResetCustomPricesButton
        {
            get => (bool)GetValue(nameof(ResetCustomPricesButton));
            set => SetValue(nameof(ResetCustomPricesButton), value);
        }
        public float RoadUpkeepMultiplier
        {
            get => (float)GetValue(nameof(RoadUpkeepMultiplier));
            set => SetValue(nameof(RoadUpkeepMultiplier), value);
        }
        public float HighwayUpkeepMultiplier
        {
            get => (float)GetValue(nameof(HighwayUpkeepMultiplier));
            set => SetValue(nameof(HighwayUpkeepMultiplier), value);
        }
        public float TrainTrackUpkeepMultiplier
        {
            get => (float)GetValue(nameof(TrainTrackUpkeepMultiplier));
            set => SetValue(nameof(TrainTrackUpkeepMultiplier), value);
        }
        public float TramTrackUpkeepMultiplier
        {
            get => (float)GetValue(nameof(TramTrackUpkeepMultiplier));
            set => SetValue(nameof(TramTrackUpkeepMultiplier), value);
        }
        public float SubwayTrackUpkeepMultiplier
        {
            get => (float)GetValue(nameof(SubwayTrackUpkeepMultiplier));
            set => SetValue(nameof(SubwayTrackUpkeepMultiplier), value);
        }
        public float LowVoltageUpkeepMultiplier
        {
            get => (float)GetValue(nameof(LowVoltageUpkeepMultiplier));
            set => SetValue(nameof(LowVoltageUpkeepMultiplier), value);
        }
        public float HighVoltageUpkeepMultiplier
        {
            get => (float)GetValue(nameof(HighVoltageUpkeepMultiplier));
            set => SetValue(nameof(HighVoltageUpkeepMultiplier), value);
        }
        public float WaterUpkeepMultiplier
        {
            get => (float)GetValue(nameof(WaterUpkeepMultiplier));
            set => SetValue(nameof(WaterUpkeepMultiplier), value);
        }
        public float SewageUpkeepMultiplier
        {
            get => (float)GetValue(nameof(SewageUpkeepMultiplier));
            set => SetValue(nameof(SewageUpkeepMultiplier), value);
        }
    }

    public class PrisonOverflowManagerSettings : SettingsBackup
    {
        public bool EnableMod
        {
            get => (bool)GetValue(nameof(EnableMod));
        ...
        {
            get => (bool)GetValue(nameof(EnableEarlyRelease));
            set => SetValue(nameof(EnableEarlyRelease), value);
        }
        public int ReleaseGraceDays
        {
            get => (int)GetValue(nameof(ReleaseGraceDays));
            set => SetValue(nameof(ReleaseGraceDays), value);
        }
        public int SweepsPerDay
        {
            get => (int)GetValue(nameof(SweepsPerDay));
    ...
    public class ProgressionControlsSettings : SettingsBackup
    {
        public bool EnableCustomProgression
        {
            get => (bool)GetValue(nameof(EnableCustomProgression));
            set => SetValue(nameof(EnableCustomProgression), value);
        }
        public int Preset
        {
            get => (int)GetValue(nameof(Preset));
        ...
        {
            get => (float)GetValue(nameof(XpPerResident));
            set => SetValue(nameof(XpPerResident), value);
        }
        public int VanillaXpPercentage
        {
            get => (int)GetValue(nameof(VanillaXpPercentage));
            set => SetValue(nameof(VanillaXpPercentage), value);
        }
        public int AppliedPreset
        {
            get => (int)GetValue(nameof(AppliedPreset));
            set => SetValue(nameof(AppliedPreset), value);
        }
        public float AppliedXpPerResident
        {
            get => (float)GetValue(nameof(AppliedXpPerResident));
            set => SetValue(nameof(AppliedXpPerResident), value);
        }
        public int AppliedVanillaXpPercentage
        {
            get => (int)GetValue(nameof(AppliedVanillaXpPercentage));
            set => SetValue(nameof(AppliedVanillaXpPercentage), value);
        }
        public int PopulationEvaluationCadence
        {
            get => (int)GetValue(nameof(PopulationEvaluationCadence));
            set => SetValue(nameof(PopulationEvaluationCadence), value);
        }
        public int PopulationXpAwardCadence
        {
            get => (int)GetValue(nameof(PopulationXpAwardCadence));
            set => SetValue(nameof(PopulationXpAwardCadence), value);
        }
    }
    ...
    public class RailwaySignalsSettings : SettingsBackup
    {
        public bool enableSignals
        {
            get => (bool)GetValue(nameof(enableSignals));
            set => SetValue(nameof(enableSignals), value);
        }
        public bool signalSubwayTracks
        {
            get => (bool)GetValue(nameof(signalSubwayTracks));
            set => SetValue(nameof(signalSubwayTracks), value);
        }
        public bool holdTrainsAtSignals
        {
            get => (bool)GetValue(nameof(holdTrainsAtSignals));
            set => SetValue(nameof(holdTrainsAtSignals), value);
        }
        public int holdReleaseSeconds
        {
            get => (int)GetValue(nameof(holdReleaseSeconds));
            set => SetValue(nameof(holdReleaseSeconds), value);
        }
        public int intermediateBlockSpacing
        {
            get => (int)GetValue(nameof(intermediateBlockSpacing));
            set => SetValue(nameof(intermediateBlockSpacing), value);
        }
        public bool intermediateOnBidirectionalTrack
        {
            get => (bool)GetValue(nameof(intermediateOnBidirectionalTrack));
            set => SetValue(nameof(intermediateOnBidirectionalTrack), value);
        }
        public int minBlockLength
        {
            get => (int)GetValue(nameof(minBlockLength));
            set => SetValue(nameof(minBlockLength), value);
        }
        public int mediumSpeedCurveRadius
        {
            get => (int)GetValue(nameof(mediumSpeedCurveRadius));
            set => SetValue(nameof(mediumSpeedCurveRadius), value);
        }
        public int mediumSpeedLimit
        {
            get => (int)GetValue(nameof(mediumSpeedLimit));
            set => SetValue(nameof(mediumSpeedLimit), value);
        }
        public int mediumSpeedBlockLength
        {
            get => (int)GetValue(nameof(mediumSpeedBlockLength));
            set => SetValue(nameof(mediumSpeedBlockLength), value);
        }
        public int minGantryTracks
        {
            get => (int)GetValue(nameof(minGantryTracks));
            set => SetValue(nameof(minGantryTracks), value);
        }
        public float maxGantryWidth
        {
            get => (float)GetValue(nameof(maxGantryWidth));
            set => SetValue(nameof(maxGantryWidth), value);
        }
        public float maxGantryTrackGap
        {
            get => (float)GetValue(nameof(maxGantryTrackGap));
            set => SetValue(nameof(maxGantryTrackGap), value);
        }
        public float gantryAlignTolerance
        {
            get => (float)GetValue(nameof(gantryAlignTolerance));
            set => SetValue(nameof(gantryAlignTolerance), value);
        }
        public float minGantryTrackSeparation
        {
            get => (float)GetValue(nameof(minGantryTrackSeparation));
            set => SetValue(nameof(minGantryTrackSeparation), value);
        }
        public float adjustSetback
        {
            get => (float)GetValue(nameof(adjustSetback));
            set => SetValue(nameof(adjustSetback), value);
        }
        public float adjustLateral
        {
            get => (float)GetValue(nameof(adjustLateral));
            set => SetValue(nameof(adjustLateral), value);
        }
        public float adjustHeight
        {
            get => (float)GetValue(nameof(adjustHeight));
            set => SetValue(nameof(adjustHeight), value);
        }
        public float adjustHeadSpacing
        {
            get => (float)GetValue(nameof(adjustHeadSpacing));
            set => SetValue(nameof(adjustHeadSpacing), value);
        }
        public float adjustGantryMargin
        {
            get => (float)GetValue(nameof(adjustGantryMargin));
            set => SetValue(nameof(adjustGantryMargin), value);
        }
        public float adjustGantryLateral
        {
            get => (float)GetValue(nameof(adjustGantryLateral));
            set => SetValue(nameof(adjustGantryLateral), value);
        }
        public float adjustGantryHeadHeight
        {
            get => (float)GetValue(nameof(adjustGantryHeadHeight));
            set => SetValue(nameof(adjustGantryHeadHeight), value);
        }
        public float adjustGantryHeadSide
        {
            get => (float)GetValue(nameof(adjustGantryHeadSide));
            set => SetValue(nameof(adjustGantryHeadSide), value);
        }
        public float adjustGantryHeadForward
        {
            get => (float)GetValue(nameof(adjustGantryHeadForward));
            set => SetValue(nameof(adjustGantryHeadForward), value);
        }
    }

    public class RealisticAlignmentSettings : SettingsBackup
    {
        public int RailStandardSetting
        {
            get => (int)GetValue(nameof(RailStandardSetting));
            set => SetValue(nameof(RailStandardSetting), value);
        }
        public bool UseSBahnStandardsForSubway
        {
            get => (bool)GetValue(nameof(UseSBahnStandardsForSubway));
            set => SetValue(nameof(UseSBahnStandardsForSubway), value);
        }
    }

    public class RealisticFundingAndManagementSettings : SettingsBackup
    {
        public bool Enabled
        {
            get => (bool)GetValue(nameof(Enabled));
        ...
        public bool BenefitsFundedByTreasury
        {
            get => (bool)GetValue(nameof(BenefitsFundedByTreasury));
            set => SetValue(nameof(BenefitsFundedByTreasury), value);
        }
        public float PensionPercent
        {
            get => (float)GetValue(nameof(PensionPercent));
            set => SetValue(nameof(PensionPercent), value);
        }
        public float UnemploymentBenefitPercent
        {
            get => (float)GetValue(nameof(UnemploymentBenefitPercent));
            set => SetValue(nameof(UnemploymentBenefitPercent), value);
        }
        public float FamilyAllowancePercent
        {
            get => (float)GetValue(nameof(FamilyAllowancePercent));
            set => SetValue(nameof(FamilyAllowancePercent), value);
        }
    }
    ...
    public class RealisticPathFindingSettings : SettingsBackup
    {
        ...
        public float game_turn_cost_multiplier
        {
            get => (float)GetValue(nameof(game_turn_cost_multiplier));
            set => SetValue(nameof(game_turn_cost_multiplier), value);
        }
        public float game_uturn_cost_multiplier
        {
            get => (float)GetValue(nameof(game_uturn_cost_multiplier));
            set => SetValue(nameof(game_uturn_cost_multiplier), value);
        }
    ...
    public class RealisticTimeAndTrafficSettings : SettingsBackup
    {
        public bool CustomTimeFlow
        {
            get => (bool)GetValue(nameof(CustomTimeFlow));
            set => SetValue(nameof(CustomTimeFlow), value);
        }
        ...
        {
            get => (int)GetValue(nameof(DateFormat));
            set => SetValue(nameof(DateFormat), value);
        }
        public float SlowerTimeFactor
        {
            get => (float)GetValue(nameof(SlowerTimeFactor));
            set => SetValue(nameof(SlowerTimeFactor), value);
        }
        public bool SyncCitizenAging
        {
            get => (bool)GetValue(nameof(SyncCitizenAging));
            set => SetValue(nameof(SyncCitizenAging), value);
        }
        public bool TrafficReduction
        {
            get => (bool)GetValue(nameof(TrafficReduction));
            set => SetValue(nameof(TrafficReduction), value);
        }
        public int TrafficReductionLevel
        {
            get => (int)GetValue(nameof(TrafficReductionLevel));
            set => SetValue(nameof(TrafficReductionLevel), value);
        }
        //public bool DebugLogging
        //{
        //    get => (bool)GetValue(nameof(DebugLogging));
    ...
    public class RealisticTripsSettings : SettingsBackup
    {
        ...
        //}
        public bool personal_car_diagnostics_enabled
        {
            get => (bool)GetValue(nameof(personal_car_diagnostics_enabled));
            set => SetValue(nameof(personal_car_diagnostics_enabled), value);
        }
    ...
    public class RealisticWorkplacesAndHouseholdsSettings : SettingsBackup
    {
        ...
        {
            get => (bool)GetValue(nameof(allow_shared_single_family_homes));
            set => SetValue(nameof(allow_shared_single_family_homes), value);
        }
        public int shared_single_family_home_rate
        {
            get => (int)GetValue(nameof(shared_single_family_home_rate));
            set => SetValue(nameof(shared_single_family_home_rate), value);
        }
        ...
        public int residential_lowrent_sqm_per_apartment
        {
            get => (int)GetValue(nameof(residential_lowrent_sqm_per_apartment));
            set => SetValue(nameof(residential_lowrent_sqm_per_apartment), value);
        }
        ...
        public int signature_residential_low_requirement_scale
        {
            get => (int)GetValue(nameof(signature_residential_low_requirement_scale));
            set => SetValue(nameof(signature_residential_low_requirement_scale), value);
        }
        public int signature_residential_medium_requirement_scale
        {
            get => (int)GetValue(nameof(signature_residential_medium_requirement_scale));
            set => SetValue(nameof(signature_residential_medium_requirement_scale), value);
        }
        public int signature_residential_high_requirement_scale
        {
            get => (int)GetValue(nameof(signature_residential_high_requirement_scale));
            set => SetValue(nameof(signature_residential_high_requirement_scale), value);
        }
        public int signature_mixed_low_requirement_scale
        {
            get => (int)GetValue(nameof(signature_mixed_low_requirement_scale));
            set => SetValue(nameof(signature_mixed_low_requirement_scale), value);
        }
        public int signature_mixed_medium_requirement_scale
        {
            get => (int)GetValue(nameof(signature_mixed_medium_requirement_scale));
            set => SetValue(nameof(signature_mixed_medium_requirement_scale), value);
        }
        public int signature_mixed_high_requirement_scale
        {
            get => (int)GetValue(nameof(signature_mixed_high_requirement_scale));
            set => SetValue(nameof(signature_mixed_high_requirement_scale), value);
        }
        public int signature_commercial_low_requirement_scale
        {
            get => (int)GetValue(nameof(signature_commercial_low_requirement_scale));
            set => SetValue(nameof(signature_commercial_low_requirement_scale), value);
        }
        public int signature_commercial_medium_requirement_scale
        {
            get => (int)GetValue(nameof(signature_commercial_medium_requirement_scale));
            set => SetValue(nameof(signature_commercial_medium_requirement_scale), value);
        }
        public int signature_commercial_high_requirement_scale
        {
            get => (int)GetValue(nameof(signature_commercial_high_requirement_scale));
            set => SetValue(nameof(signature_commercial_high_requirement_scale), value);
        }
        public int signature_office_low_requirement_scale
        {
            get => (int)GetValue(nameof(signature_office_low_requirement_scale));
            set => SetValue(nameof(signature_office_low_requirement_scale), value);
        }
        public int signature_office_medium_requirement_scale
        {
            get => (int)GetValue(nameof(signature_office_medium_requirement_scale));
            set => SetValue(nameof(signature_office_medium_requirement_scale), value);
        }
        public int signature_office_high_requirement_scale
        {
            get => (int)GetValue(nameof(signature_office_high_requirement_scale));
            set => SetValue(nameof(signature_office_high_requirement_scale), value);
        }
        public int signature_industrial_requirement_scale
        {
            get => (int)GetValue(nameof(signature_industrial_requirement_scale));
            set => SetValue(nameof(signature_industrial_requirement_scale), value);
        }
    ...
    public class RealWeatherSyncSettings : SettingsBackup
    {
        public bool EnableRealWeather
        {
            get => (bool)GetValue(nameof(EnableRealWeather));
            set => SetValue(nameof(EnableRealWeather), value);
        }
        public bool FollowGameClock
        {
            get => (bool)GetValue(nameof(FollowGameClock));
            set => SetValue(nameof(FollowGameClock), value);
        }
        public bool SmoothTransitions
        {
            get => (bool)GetValue(nameof(SmoothTransitions));
            set => SetValue(nameof(SmoothTransitions), value);
        }
        public int TransitionSeconds
        {
            get => (int)GetValue(nameof(TransitionSeconds));
            set => SetValue(nameof(TransitionSeconds), value);
        }
        ...
        {
            get => (string)GetValue(nameof(CityQuery));
            set => SetValue(nameof(CityQuery), value);
        }
        public string SelectedSearchResult
        {
            get => (string)GetValue(nameof(SelectedSearchResult));
            set => SetValue(nameof(SelectedSearchResult), value);
        }
        public string SelectedFavourite
        {
            get => (string)GetValue(nameof(SelectedFavourite));
            set => SetValue(nameof(SelectedFavourite), value);
        }
        public bool SyncFog
        {
            get => (bool)GetValue(nameof(SyncFog));
            set => SetValue(nameof(SyncFog), value);
        }
        public bool SyncTemperature
        {
            get => (bool)GetValue(nameof(SyncTemperature));
            set => SetValue(nameof(SyncTemperature), value);
        }
        public bool ForceSnowAppearance
        {
            get => (bool)GetValue(nameof(ForceSnowAppearance));
            set => SetValue(nameof(ForceSnowAppearance), value);
        }
        public bool IgnoreModConflicts
        {
            get => (bool)GetValue(nameof(IgnoreModConflicts));
            set => SetValue(nameof(IgnoreModConflicts), value);
        }
        public int TimeShiftHours
        {
            get => (int)GetValue(nameof(TimeShiftHours));
            set => SetValue(nameof(TimeShiftHours), value);
        }
        public bool AntipodeMode
        {
            get => (bool)GetValue(nameof(AntipodeMode));
            set => SetValue(nameof(AntipodeMode), value);
        }
        public int ExtremeLocation
        {
            get => (int)GetValue(nameof(ExtremeLocation));
            set => SetValue(nameof(ExtremeLocation), value);
        }
        public bool OppositeDay
        {
            get => (bool)GetValue(nameof(OppositeDay));
            set => SetValue(nameof(OppositeDay), value);
        }
        public bool HasResolvedLocation
        {
            get => (bool)GetValue(nameof(HasResolvedLocation));
            set => SetValue(nameof(HasResolvedLocation), value);
        }
        public string ResolvedName
        {
            get => (string)GetValue(nameof(ResolvedName));
            set => SetValue(nameof(ResolvedName), value);
        }
        public string ResolvedAdmin1
        {
            get => (string)GetValue(nameof(ResolvedAdmin1));
            set => SetValue(nameof(ResolvedAdmin1), value);
        }
        public string ResolvedCountry
        {
            get => (string)GetValue(nameof(ResolvedCountry));
            set => SetValue(nameof(ResolvedCountry), value);
        }
        public string ResolvedCountryCode
        {
            get => (string)GetValue(nameof(ResolvedCountryCode));
            set => SetValue(nameof(ResolvedCountryCode), value);
        }
        public string ResolvedTimezone
        {
            get => (string)GetValue(nameof(ResolvedTimezone));
            set => SetValue(nameof(ResolvedTimezone), value);
        }
        public string ResolvedQuery
        {
            get => (string)GetValue(nameof(ResolvedQuery));
            set => SetValue(nameof(ResolvedQuery), value);
        }
        public float ResolvedLatitude
        {
            get => (float)GetValue(nameof(ResolvedLatitude));
            set => SetValue(nameof(ResolvedLatitude), value);
        }
        public float ResolvedLongitude
        {
            get => (float)GetValue(nameof(ResolvedLongitude));
            set => SetValue(nameof(ResolvedLongitude), value);
        }
        public string FavouritesRaw
        {
            get => (string)GetValue(nameof(FavouritesRaw));
            set => SetValue(nameof(FavouritesRaw), value);
        }
    }
    ...
    public class RecolorSettings : SettingsBackup
    {
        ...
        public bool HideVanillaColorCustomizationPanel
        {
            get => (bool)GetValue(nameof(HideVanillaColorCustomizationPanel));
            set => SetValue(nameof(HideVanillaColorCustomizationPanel), value);
        }
    ...
    public class RemoveAbandonedCarsSettings : SettingsBackup
    {
        public bool IsDeletionProcessActive
        {
            get => (bool)GetValue(nameof(IsDeletionProcessActive));
            set => SetValue(nameof(IsDeletionProcessActive), value);
        }
        public bool IsDeletionOfParkedVehiclesProcessActive
        {
            get => (bool)GetValue(nameof(IsDeletionOfParkedVehiclesProcessActive));
            set => SetValue(nameof(IsDeletionOfParkedVehiclesProcessActive), value);
        }
        public int DeletedDummyVehiclesCount
        {
            get => (int)GetValue(nameof(DeletedDummyVehiclesCount));
            set => SetValue(nameof(DeletedDummyVehiclesCount), value);
        }
        public int DeletedParkedVehiclesCount
        {
            get => (int)GetValue(nameof(DeletedParkedVehiclesCount));
            set => SetValue(nameof(DeletedParkedVehiclesCount), value);
        }
        public bool DisableTrafficSpawnerAIState
        {
            get => (bool)GetValue(nameof(DisableTrafficSpawnerAIState));
            set => SetValue(nameof(DisableTrafficSpawnerAIState), value);
        }
        public bool EnableDeletionOfAbandonedTrailers
        {
            get => (bool)GetValue(nameof(EnableDeletionOfAbandonedTrailers));
            set => SetValue(nameof(EnableDeletionOfAbandonedTrailers), value);
        }
        public bool ToggleDeletionOfAbandonedTrailers
        {
            get => (bool)GetValue(nameof(ToggleDeletionOfAbandonedTrailers));
            set => SetValue(nameof(ToggleDeletionOfAbandonedTrailers), value);
        }
        public bool ToggleTrafficSpawnerAIState
        {
            get => (bool)GetValue(nameof(ToggleTrafficSpawnerAIState));
            set => SetValue(nameof(ToggleTrafficSpawnerAIState), value);
        }
        public float SlotDivisorSlider
        {
            get => (float)GetValue(nameof(SlotDivisorSlider));
            set => SetValue(nameof(SlotDivisorSlider), value);
        }
    }
    ...
    public class RoadNameGeneratorSettings : SettingsBackup
    {
        public int SelectedNamingStyle
        {
            get => (int)GetValue(nameof(SelectedNamingStyle));
            set => SetValue(nameof(SelectedNamingStyle), value);
        }
        public bool AutomaticallyRenameNewRoads
        {
            get => (bool)GetValue(nameof(AutomaticallyRenameNewRoads));
            set => SetValue(nameof(AutomaticallyRenameNewRoads), value);
        }
        public int ExistingRoadCheckMode
        {
            get => (int)GetValue(nameof(ExistingRoadCheckMode));
            set => SetValue(nameof(ExistingRoadCheckMode), value);
        }
        //public bool EnableDetailedLogging
        //{
        //    get => (bool)GetValue(nameof(EnableDetailedLogging));
        //    set => SetValue(nameof(EnableDetailedLogging), value);
        //}
    }
    ...
    public class RoadRuleSettings : SettingsBackup { }
    ...
    public class RoundaboutMarkerSettings : SettingsBackup
    {
        public float ConnectionSoundVolume
        {
            get => (float)GetValue(nameof(ConnectionSoundVolume));
            set => SetValue(nameof(ConnectionSoundVolume), value);
        }
        public bool ShowUsageInstructions
        {
            get => (bool)GetValue(nameof(ShowUsageInstructions));
            set => SetValue(nameof(ShowUsageInstructions), value);
        }
    }

    public class RouteFilterSettings : SettingsBackup
    {
        public bool EnableExactRestrictions
        {
            get => (bool)GetValue(nameof(EnableExactRestrictions));
            set => SetValue(nameof(EnableExactRestrictions), value);
        }
        public bool ProtectEmergencyVehicles
        {
            get => (bool)GetValue(nameof(ProtectEmergencyVehicles));
            set => SetValue(nameof(ProtectEmergencyVehicles), value);
        }
        public int LookAheadLanes
        {
            get => (int)GetValue(nameof(LookAheadLanes));
            set => SetValue(nameof(LookAheadLanes), value);
        }
    }
    ...
    public class ScorchedEarthSettings : SettingsBackup
    {
        public int BuildingSpread
        {
            get => (int)GetValue(nameof(BuildingSpread));
            set => SetValue(nameof(BuildingSpread), value);
        }
        public int BuildingSpreadRange
        {
            get => (int)GetValue(nameof(BuildingSpreadRange));
            set => SetValue(nameof(BuildingSpreadRange), value);
        }
        public int VegetationSpread
        {
            get => (int)GetValue(nameof(VegetationSpread));
            set => SetValue(nameof(VegetationSpread), value);
        }
        public int VegetationSpreadRange
        {
            get => (int)GetValue(nameof(VegetationSpreadRange));
            set => SetValue(nameof(VegetationSpreadRange), value);
        }
        public int CollapseSpeed
        {
            get => (int)GetValue(nameof(CollapseSpeed));
            set => SetValue(nameof(CollapseSpeed), value);
        }
        public bool CharBuildings
        {
            get => (bool)GetValue(nameof(CharBuildings));
            set => SetValue(nameof(CharBuildings), value);
        }
        public bool CharTrees
        {
            get => (bool)GetValue(nameof(CharTrees));
            set => SetValue(nameof(CharTrees), value);
        }
        public int CharStrength
        {
            get => (int)GetValue(nameof(CharStrength));
            set => SetValue(nameof(CharStrength), value);
        }
        public int CharRecoveryDays
        {
            get => (int)GetValue(nameof(CharRecoveryDays));
            set => SetValue(nameof(CharRecoveryDays), value);
        }
        public int TreeRecoveryDays
        {
            get => (int)GetValue(nameof(TreeRecoveryDays));
            set => SetValue(nameof(TreeRecoveryDays), value);
        }
        public bool ScorchGround
        {
            get => (bool)GetValue(nameof(ScorchGround));
            set => SetValue(nameof(ScorchGround), value);
        }
        public int ScorchChannel
        {
            get => (int)GetValue(nameof(ScorchChannel));
            set => SetValue(nameof(ScorchChannel), value);
        }
        public int ScorchRadius
        {
            get => (int)GetValue(nameof(ScorchRadius));
            set => SetValue(nameof(ScorchRadius), value);
        }
        public int ScorchOpacity
        {
            get => (int)GetValue(nameof(ScorchOpacity));
            set => SetValue(nameof(ScorchOpacity), value);
        }
        public int UpdateInterval
        {
            get => (int)GetValue(nameof(UpdateInterval));
    ...
    public class SeetySettings : SettingsBackup
    {
        public bool ShowStrip
        {
            get => (bool)GetValue(nameof(ShowStrip));
            set => SetValue(nameof(ShowStrip), value);
        }
        public bool HighlightProblems
        {
            get => (bool)GetValue(nameof(HighlightProblems));
            set => SetValue(nameof(HighlightProblems), value);
        }
        public int StripX
        {
            get => (int)GetValue(nameof(StripX));
            set => SetValue(nameof(StripX), value);
        }
        public int StripY
        {
            get => (int)GetValue(nameof(StripY));
            set => SetValue(nameof(StripY), value);
        }
        public bool SeededDefaults
        {
            get => (bool)GetValue(nameof(SeededDefaults));
            set => SetValue(nameof(SeededDefaults), value);
        }
        public string DisabledVitals
        {
            get => (string)GetValue(nameof(DisabledVitals));
            set => SetValue(nameof(DisabledVitals), value);
        }
        public int FundsAmount
        {
            get => (int)GetValue(nameof(FundsAmount));
            set => SetValue(nameof(FundsAmount), value);
        }
    }
    ...
    public class ServiceSanitationLevySettings : SettingsBackup
    {
        public bool LevyEnabled
        {
            get => (bool)GetValue(nameof(LevyEnabled));
            set => SetValue(nameof(LevyEnabled), value);
        }
        public float PsfEmergencyPercent
        {
            get => (float)GetValue(nameof(PsfEmergencyPercent));
            set => SetValue(nameof(PsfEmergencyPercent), value);
        }
        public float PsfGarbagePercent
        {
            get => (float)GetValue(nameof(PsfGarbagePercent));
            set => SetValue(nameof(PsfGarbagePercent), value);
        }
    }

    public class ShowInvisibleNetworksSettings : SettingsBackup
    {
        public bool ShowInvisibleNetworks
        {
            get => (bool)GetValue(nameof(ShowInvisibleNetworks));
            set => SetValue(nameof(ShowInvisibleNetworks), value);
        }
    }
    ...
    public class SignatureLogisticsSettings : SettingsBackup
    {
        public int MaxVehicles
        {
            get => (int)GetValue(nameof(MaxVehicles));
            set => SetValue(nameof(MaxVehicles), value);
        }
        public int MaxStorage
        {
            get => (int)GetValue(nameof(MaxStorage));
            set => SetValue(nameof(MaxStorage), value);
        }
        public int RestockTarget
        {
            get => (int)GetValue(nameof(RestockTarget));
            set => SetValue(nameof(RestockTarget), value);
        }
        public bool UseChangeCompanyForEmployees
        {
            get => (bool)GetValue(nameof(UseChangeCompanyForEmployees));
            set => SetValue(nameof(UseChangeCompanyForEmployees), value);
        }
        public int WorkerMultiplier
        {
            get => (int)GetValue(nameof(WorkerMultiplier));
            set => SetValue(nameof(WorkerMultiplier), value);
        }
        public int ProductionMultiplier
        {
            get => (int)GetValue(nameof(ProductionMultiplier));
            set => SetValue(nameof(ProductionMultiplier), value);
        }
    }
    ...
    public class SirenChangerSettings : SettingsBackup
    {
        ...
        {
            get => (string)GetValue(nameof(AmbientWorldOverrideTarget));
            set => SetValue(nameof(AmbientWorldOverrideTarget), value);
        }
        public string AmbientWorldOverrideSelection
        {
            get => (string)GetValue(nameof(AmbientWorldOverrideSelection));
            set => SetValue(nameof(AmbientWorldOverrideSelection), value);
        }
        public string AmbientDisasterOverrideTarget
        {
            get => (string)GetValue(nameof(AmbientDisasterOverrideTarget));
            set => SetValue(nameof(AmbientDisasterOverrideTarget), value);
        }
        public string AmbientDisasterOverrideSelection
        {
            get => (string)GetValue(nameof(AmbientDisasterOverrideSelection));
            set => SetValue(nameof(AmbientDisasterOverrideSelection), value);
        }
        ...
        {
            get => (string)GetValue(nameof(BuildingServiceOverrideTarget));
            set => SetValue(nameof(BuildingServiceOverrideTarget), value);
        }
        public string BuildingServiceOverrideSelection
        {
            get => (string)GetValue(nameof(BuildingServiceOverrideSelection));
            set => SetValue(nameof(BuildingServiceOverrideSelection), value);
        }
        ...
        {
            get => (bool)GetValue(nameof(UIToolEnabled));
            set => SetValue(nameof(UIToolEnabled), value);
        }
        public bool UIToolMuteAllTargets
        {
            get => (bool)GetValue(nameof(UIToolMuteAllTargets));
            set => SetValue(nameof(UIToolMuteAllTargets), value);
        }
        public string UIToolOverrideTarget
        {
            get => (string)GetValue(nameof(UIToolOverrideTarget));
            set => SetValue(nameof(UIToolOverrideTarget), value);
        }
        public string UIToolOverrideSelection
        {
            get => (string)GetValue(nameof(UIToolOverrideSelection));
            set => SetValue(nameof(UIToolOverrideSelection), value);
        }
        public int MissingUIToolFallbackBehavior
        {
            get => (int)GetValue(nameof(MissingUIToolFallbackBehavior));
            set => SetValue(nameof(MissingUIToolFallbackBehavior), value);
        }
        public string AlternateUIToolFallbackSelection
        {
            get => (string)GetValue(nameof(AlternateUIToolFallbackSelection));
            set => SetValue(nameof(AlternateUIToolFallbackSelection), value);
        }
        public string EditUIToolProfile
        {
            get => (string)GetValue(nameof(EditUIToolProfile));
            set => SetValue(nameof(EditUIToolProfile), value);
        }
        public string CopyFromUIToolProfile
        {
            get => (string)GetValue(nameof(CopyFromUIToolProfile));
            set => SetValue(nameof(CopyFromUIToolProfile), value);
        }
        public float UIToolProfileVolume
        {
            get => (float)GetValue(nameof(UIToolProfileVolume));
            set => SetValue(nameof(UIToolProfileVolume), value);
        }
        public float UIToolProfilePitch
        {
            get => (float)GetValue(nameof(UIToolProfilePitch));
            set => SetValue(nameof(UIToolProfilePitch), value);
        }
        public float UIToolProfileSpatialBlend
        {
            get => (float)GetValue(nameof(UIToolProfileSpatialBlend));
            set => SetValue(nameof(UIToolProfileSpatialBlend), value);
        }
        public float UIToolProfileDoppler
        {
            get => (float)GetValue(nameof(UIToolProfileDoppler));
            set => SetValue(nameof(UIToolProfileDoppler), value);
        }
        public float UIToolProfileSpread
        {
            get => (float)GetValue(nameof(UIToolProfileSpread));
            set => SetValue(nameof(UIToolProfileSpread), value);
        }
        public float UIToolProfileMinDistance
        {
            get => (float)GetValue(nameof(UIToolProfileMinDistance));
            set => SetValue(nameof(UIToolProfileMinDistance), value);
        }
        public float UIToolProfileMaxDistance
        {
            get => (float)GetValue(nameof(UIToolProfileMaxDistance));
            set => SetValue(nameof(UIToolProfileMaxDistance), value);
        }
        public bool UIToolProfileLoop
        {
            get => (bool)GetValue(nameof(UIToolProfileLoop));
            set => SetValue(nameof(UIToolProfileLoop), value);
        }
        public int UIToolProfileRolloffMode
        {
            get => (int)GetValue(nameof(UIToolProfileRolloffMode));
            set => SetValue(nameof(UIToolProfileRolloffMode), value);
        }
        public bool UIToolProfileRandomStartTime
        {
            get => (bool)GetValue(nameof(UIToolProfileRandomStartTime));
            set => SetValue(nameof(UIToolProfileRandomStartTime), value);
        }
        public float UIToolProfileFadeInSeconds
        {
            get => (float)GetValue(nameof(UIToolProfileFadeInSeconds));
            set => SetValue(nameof(UIToolProfileFadeInSeconds), value);
        }
        public float UIToolProfileFadeOutSeconds
        {
            get => (float)GetValue(nameof(UIToolProfileFadeOutSeconds));
            set => SetValue(nameof(UIToolProfileFadeOutSeconds), value);
        }
        ...
        {
            get => (string)GetValue(nameof(DeveloperModuleLocalUIToolSelection));
            set => SetValue(nameof(DeveloperModuleLocalUIToolSelection), value);
        }
        ...
        {
            get => (string)GetValue(nameof(TransitAnnouncementLinePreArrivalOverride));
            set => SetValue(nameof(TransitAnnouncementLinePreArrivalOverride), value);
        }
        ...
        {
            get => (string)GetValue(nameof(TransitEmergencyEvacuationArrivalSelection));
            set => SetValue(nameof(TransitEmergencyEvacuationArrivalSelection), value);
        }
        public string TransitEmergencyEvacuationDepartureSelection
        {
            get => (string)GetValue(nameof(TransitEmergencyEvacuationDepartureSelection));
            set => SetValue(nameof(TransitEmergencyEvacuationDepartureSelection), value);
        }
        public string TransitEmergencyPrisonerArrivalSelection
        {
            get => (string)GetValue(nameof(TransitEmergencyPrisonerArrivalSelection));
            set => SetValue(nameof(TransitEmergencyPrisonerArrivalSelection), value);
        }
        public string TransitEmergencyPrisonerDepartureSelection
        {
            get => (string)GetValue(nameof(TransitEmergencyPrisonerDepartureSelection));
            set => SetValue(nameof(TransitEmergencyPrisonerDepartureSelection), value);
        }
    }

    public class SkylinesMapsSettings : SettingsBackup
    {
        public int Palette
        {
            get => (int)GetValue(nameof(Palette));
            set => SetValue(nameof(Palette), value);
        }
        public bool ShowCityTraffic
        {
            get => (bool)GetValue(nameof(ShowCityTraffic));
            set => SetValue(nameof(ShowCityTraffic), value);
        }
        public int MinimumTraffic
        {
            get => (int)GetValue(nameof(MinimumTraffic));
            set => SetValue(nameof(MinimumTraffic), value);
        }
        public int Responsiveness
        {
            get => (int)GetValue(nameof(Responsiveness));
            set => SetValue(nameof(Responsiveness), value);
        }
        public int GradientSteps
        {
            get => (int)GetValue(nameof(GradientSteps));
            set => SetValue(nameof(GradientSteps), value);
        }
        public int JammedBelow
        {
            get => (int)GetValue(nameof(JammedBelow));
            set => SetValue(nameof(JammedBelow), value);
        }
        public int FreeFlowingAbove
        {
            get => (int)GetValue(nameof(FreeFlowingAbove));
            set => SetValue(nameof(FreeFlowingAbove), value);
        }
    }

    public class SkyplanSettings : SettingsBackup
    {
        public string ExportPlanName
        {
            get => (string)GetValue(nameof(ExportPlanName));
            set => SetValue(nameof(ExportPlanName), value);
        }
        public string ExportIteration
        {
            get => (string)GetValue(nameof(ExportIteration));
            set => SetValue(nameof(ExportIteration), value);
        }
        public string ImportFileName
        {
            get => (string)GetValue(nameof(ImportFileName));
            set => SetValue(nameof(ImportFileName), value);
        }
    }
    ...
    public class StopJaywalkingSettings : SettingsBackup
    {
        public bool Enabled
        {
            get => (bool)GetValue(nameof(Enabled));
        ...
        {
            get => (float)GetValue(nameof(CostMultiplier));
            set => SetValue(nameof(CostMultiplier), value);
        }
        public int ReassertIntervalHours
        {
            get => (int)GetValue(nameof(ReassertIntervalHours));
            set => SetValue(nameof(ReassertIntervalHours), value);
        }
    }
    ...
    public class TasklySettings : SettingsBackup
    {
        public bool ShowInUniversalModMenu
        {
            get => (bool)GetValue(nameof(ShowInUniversalModMenu));
            set => SetValue(nameof(ShowInUniversalModMenu), value);
        }
    }

    public class TaxiTrafficSettings : SettingsBackup
    {
        public int ResidentsAvoidTaxis
        {
            get => (int)GetValue(nameof(ResidentsAvoidTaxis));
            set => SetValue(nameof(ResidentsAvoidTaxis), value);
        }
        public bool BlockCommuters
        {
            get => (bool)GetValue(nameof(BlockCommuters));
            set => SetValue(nameof(BlockCommuters), value);
        }
        public bool BlockTourists
        {
            get => (bool)GetValue(nameof(BlockTourists));
            set => SetValue(nameof(BlockTourists), value);
        }
        public bool ShowLastUpdateInfo
        {
            get => (bool)GetValue(nameof(ShowLastUpdateInfo));
            set => SetValue(nameof(ShowLastUpdateInfo), value);
        }
        //public bool EnableDebugLogging
        //{
        //    get => (bool)GetValue(nameof(EnableDebugLogging));
    ...
    public class ToggleEdgeScrollingSettings : SettingsBackup
    {
        public bool DisableOnStartup
        {
            get => (bool)GetValue(nameof(DisableOnStartup));
            set => SetValue(nameof(DisableOnStartup), value);
        }
        public bool DisableInBackground
        {
            get => (bool)GetValue(nameof(DisableInBackground));
            set => SetValue(nameof(DisableInBackground), value);
        }
        public int Button
        {
            get => (int)GetValue(nameof(Button));
            set => SetValue(nameof(Button), value);
        }
    }
    ...
    public class TourismOverhaulSettings : SettingsBackup
    {
        public int TouristsPerThousandCitizens
        {
            get => (int)GetValue(nameof(TouristsPerThousandCitizens));
            set => SetValue(nameof(TouristsPerThousandCitizens), value);
        }
        public int HistoricBuildingAttractiveness
        {
            get => (int)GetValue(nameof(HistoricBuildingAttractiveness));
            set => SetValue(nameof(HistoricBuildingAttractiveness), value);
        }
        public bool EnableAttractionCrowding
        {
            get => (bool)GetValue(nameof(EnableAttractionCrowding));
            set => SetValue(nameof(EnableAttractionCrowding), value);
        }
        public int AttractionCrowdTolerance
        {
            get => (int)GetValue(nameof(AttractionCrowdTolerance));
            set => SetValue(nameof(AttractionCrowdTolerance), value);
        }
        public int MaximumTourists
        {
            get => (int)GetValue(nameof(MaximumTourists));
            set => SetValue(nameof(MaximumTourists), value);
        }
        public int PreferLargerTouristGroups
        {
            get => (int)GetValue(nameof(PreferLargerTouristGroups));
            set => SetValue(nameof(PreferLargerTouristGroups), value);
        }
        public int TouristShoppingChance
        {
            get => (int)GetValue(nameof(TouristShoppingChance));
            set => SetValue(nameof(TouristShoppingChance), value);
        }
        public int LodgingCostPercent
        {
            get => (int)GetValue(nameof(LodgingCostPercent));
            set => SetValue(nameof(LodgingCostPercent), value);
        }
        public int SpendingPerNightPercent
        {
            get => (int)GetValue(nameof(SpendingPerNightPercent));
            set => SetValue(nameof(SpendingPerNightPercent), value);
        }
        public int WealthVariationPercent
        {
            get => (int)GetValue(nameof(WealthVariationPercent));
            set => SetValue(nameof(WealthVariationPercent), value);
        }
        public int LeisureCostPercent
        {
            get => (int)GetValue(nameof(LeisureCostPercent));
            set => SetValue(nameof(LeisureCostPercent), value);
        }
        public int CruiseShoreLeaveHours
        {
            get => (int)GetValue(nameof(CruiseShoreLeaveHours));
            set => SetValue(nameof(CruiseShoreLeaveHours), value);
        }
        public int CruiseShipCapacity
        {
            get => (int)GetValue(nameof(CruiseShipCapacity));
            set => SetValue(nameof(CruiseShipCapacity), value);
        }
        public int LeisureCapacityMultiplier
        {
            get => (int)GetValue(nameof(LeisureCapacityMultiplier));
            set => SetValue(nameof(LeisureCapacityMultiplier), value);
        }
        public int ArrivalWeightRoad
        {
            get => (int)GetValue(nameof(ArrivalWeightRoad));
            set => SetValue(nameof(ArrivalWeightRoad), value);
        }
        public int ArrivalWeightTrain
        {
            get => (int)GetValue(nameof(ArrivalWeightTrain));
            set => SetValue(nameof(ArrivalWeightTrain), value);
        }
        public int ArrivalWeightAir
        {
            get => (int)GetValue(nameof(ArrivalWeightAir));
            set => SetValue(nameof(ArrivalWeightAir), value);
        }
        public int ArrivalWeightShip
        {
            get => (int)GetValue(nameof(ArrivalWeightShip));
            set => SetValue(nameof(ArrivalWeightShip), value);
        }
        public int TouristCarChance
        {
            get => (int)GetValue(nameof(TouristCarChance));
            set => SetValue(nameof(TouristCarChance), value);
        }
        public int HotelRoomMultiplier
        {
            get => (int)GetValue(nameof(HotelRoomMultiplier));
            set => SetValue(nameof(HotelRoomMultiplier), value);
        }
        public bool EnableHotelZones
        {
            get => (bool)GetValue(nameof(EnableHotelZones));
            set => SetValue(nameof(EnableHotelZones), value);
        }
        public bool EnableHotelWelcome
        {
            get => (bool)GetValue(nameof(EnableHotelWelcome));
            set => SetValue(nameof(EnableHotelWelcome), value);
        }
        public int AverageStayDays
        {
            get => (int)GetValue(nameof(AverageStayDays));
            set => SetValue(nameof(AverageStayDays), value);
        }
        public bool EnableResidentHolidays
        {
            get => (bool)GetValue(nameof(EnableResidentHolidays));
            set => SetValue(nameof(EnableResidentHolidays), value);
        }
        public int HolidayTripsPerThousandHouseholds
        {
            get => (int)GetValue(nameof(HolidayTripsPerThousandHouseholds));
            set => SetValue(nameof(HolidayTripsPerThousandHouseholds), value);
        }
        public bool HighlightTourists
        {
            get => (bool)GetValue(nameof(HighlightTourists));
            set => SetValue(nameof(HighlightTourists), value);
        }
        public bool HighlightTouristVehicles
        {
            get => (bool)GetValue(nameof(HighlightTouristVehicles));
            set => SetValue(nameof(HighlightTouristVehicles), value);
        }
        public int MarkerRed
        {
            get => (int)GetValue(nameof(MarkerRed));
            set => SetValue(nameof(MarkerRed), value);
        }
        public int MarkerGreen
        {
            get => (int)GetValue(nameof(MarkerGreen));
            set => SetValue(nameof(MarkerGreen), value);
        }
        public int MarkerBlue
        {
            get => (int)GetValue(nameof(MarkerBlue));
            set => SetValue(nameof(MarkerBlue), value);
        }

        //public bool DiagnosticLogging
        //{
        //    get => (bool)GetValue(nameof(DiagnosticLogging));
        //    set => SetValue(nameof(DiagnosticLogging), value);
        //}
        public bool FixArrivalRouting
        {
            get => (bool)GetValue(nameof(FixArrivalRouting));
            set => SetValue(nameof(FixArrivalRouting), value);
        }
        public bool FixTouristTargetSearch
        {
            get => (bool)GetValue(nameof(FixTouristTargetSearch));
            set => SetValue(nameof(FixTouristTargetSearch), value);
        }
        public bool ReclaimAbandonedHotelRooms
        {
            get => (bool)GetValue(nameof(ReclaimAbandonedHotelRooms));
            set => SetValue(nameof(ReclaimAbandonedHotelRooms), value);
        }
        public bool PreferAirAndSea
        {
            get => (bool)GetValue(nameof(PreferAirAndSea));
            set => SetValue(nameof(PreferAirAndSea), value);
        }
        public bool LoadAwareArrivals
        {
            get => (bool)GetValue(nameof(LoadAwareArrivals));
            set => SetValue(nameof(LoadAwareArrivals), value);
        }
        public int ArrivalBacklogSensitivity
        {
            get => (int)GetValue(nameof(ArrivalBacklogSensitivity));
            set => SetValue(nameof(ArrivalBacklogSensitivity), value);
        }
        public bool FixTouristDemand
        {
            get => (bool)GetValue(nameof(FixTouristDemand));
            set => SetValue(nameof(FixTouristDemand), value);
        }
        public int MaxArrivalsPerUpdate
        {
            get => (int)GetValue(nameof(MaxArrivalsPerUpdate));
            set => SetValue(nameof(MaxArrivalsPerUpdate), value);
        }
        public int HotelRoomDemandOccupancy
        {
            get => (int)GetValue(nameof(HotelRoomDemandOccupancy));
            set => SetValue(nameof(HotelRoomDemandOccupancy), value);
        }
        public bool ReplaceNativeSpawner
        {
            get => (bool)GetValue(nameof(ReplaceNativeSpawner));
            set => SetValue(nameof(ReplaceNativeSpawner), value);
        }
        public int HotelWelcomeDays
        {
            get => (int)GetValue(nameof(HotelWelcomeDays));
            set => SetValue(nameof(HotelWelcomeDays), value);
        }
        public int HotelWelcomeBoost
        {
            get => (int)GetValue(nameof(HotelWelcomeBoost));
            set => SetValue(nameof(HotelWelcomeBoost), value);
        }
        public int HotelWelcomeArrivalMultiplier
        {
            get => (int)GetValue(nameof(HotelWelcomeArrivalMultiplier));
            set => SetValue(nameof(HotelWelcomeArrivalMultiplier), value);
        }
        public int HotelWelcomeStock
        {
            get => (int)GetValue(nameof(HotelWelcomeStock));
            set => SetValue(nameof(HotelWelcomeStock), value);
        }
        public bool EnableHotelEfficiencyFloor
        {
            get => (bool)GetValue(nameof(EnableHotelEfficiencyFloor));
            set => SetValue(nameof(EnableHotelEfficiencyFloor), value);
        }
        public int HotelEfficiencyFloor
        {
            get => (int)GetValue(nameof(HotelEfficiencyFloor));
            set => SetValue(nameof(HotelEfficiencyFloor), value);
        }
        public bool RebookDisplacedTourists
        {
            get => (bool)GetValue(nameof(RebookDisplacedTourists));
            set => SetValue(nameof(RebookDisplacedTourists), value);
        }
        public int MaxRebookingsPerUpdate
        {
            get => (int)GetValue(nameof(MaxRebookingsPerUpdate));
            set => SetValue(nameof(MaxRebookingsPerUpdate), value);
        }
        public bool FixTouristBudget
        {
            get => (bool)GetValue(nameof(FixTouristBudget));
            set => SetValue(nameof(FixTouristBudget), value);
        }
        public int TouristBudgetDays
        {
            get => (int)GetValue(nameof(TouristBudgetDays));
            set => SetValue(nameof(TouristBudgetDays), value);
        }
        public bool FixHotelDemand
        {
            get => (bool)GetValue(nameof(FixHotelDemand));
            set => SetValue(nameof(FixHotelDemand), value);
        }
        public float HotelRoomsPerTourist
        {
            get => (float)GetValue(nameof(HotelRoomsPerTourist));
            set => SetValue(nameof(HotelRoomsPerTourist), value);
        }
        public bool FixLengthOfStay
        {
            get => (bool)GetValue(nameof(FixLengthOfStay));
            set => SetValue(nameof(FixLengthOfStay), value);
        }
        public bool FixReporting
        {
            get => (bool)GetValue(nameof(FixReporting));
            set => SetValue(nameof(FixReporting), value);
        }
        public int HolidayMinimumSavings
        {
            get => (int)GetValue(nameof(HolidayMinimumSavings));
            set => SetValue(nameof(HolidayMinimumSavings), value);
        }
        public float MarkerSize
        {
            get => (float)GetValue(nameof(MarkerSize));
            set => SetValue(nameof(MarkerSize), value);
        }
        public int MarkerOpacity
        {
            get => (int)GetValue(nameof(MarkerOpacity));
            set => SetValue(nameof(MarkerOpacity), value);
        }
    }

    public class TownRoadLaneSettings : SettingsBackup
    {
        public bool EdgeLineEnabled
        {
            get => (bool)GetValue(nameof(EdgeLineEnabled));
            set => SetValue(nameof(EdgeLineEnabled), value);
        }
        public int EdgeLineStyle
        {
            get => (int)GetValue(nameof(EdgeLineStyle));
            set => SetValue(nameof(EdgeLineStyle), value);
        }
        public bool YellowLeftLineEnabled
        {
            get => (bool)GetValue(nameof(YellowLeftLineEnabled));
            set => SetValue(nameof(YellowLeftLineEnabled), value);
        }
        public bool ParkingMarkingsEnabled
        {
            get => (bool)GetValue(nameof(ParkingMarkingsEnabled));
            set => SetValue(nameof(ParkingMarkingsEnabled), value);
        }
        public int ParkingLineStyle
        {
            get => (int)GetValue(nameof(ParkingLineStyle));
            set => SetValue(nameof(ParkingLineStyle), value);
        }
        public int ParkingEndStyle
        {
            get => (int)GetValue(nameof(ParkingEndStyle));
            set => SetValue(nameof(ParkingEndStyle), value);
        }
        public float SegmentMinLengthM
        {
            get => (float)GetValue(nameof(SegmentMinLengthM));
            set => SetValue(nameof(SegmentMinLengthM), value);
        }
        public float SegmentAnchorDeadZoneM
        {
            get => (float)GetValue(nameof(SegmentAnchorDeadZoneM));
            set => SetValue(nameof(SegmentAnchorDeadZoneM), value);
        }
        public int SegmentMinCrossingAngleDeg
        {
            get => (int)GetValue(nameof(SegmentMinCrossingAngleDeg));
            set => SetValue(nameof(SegmentMinCrossingAngleDeg), value);
        }
        public float SegmentHitClusterM
        {
            get => (float)GetValue(nameof(SegmentHitClusterM));
            set => SetValue(nameof(SegmentHitClusterM), value);
        }
        public string PinnedLineStylesCsv
        {
            get => (string)GetValue(nameof(PinnedLineStylesCsv));
            set => SetValue(nameof(PinnedLineStylesCsv), value);
        }
        public string PinnedAreaStylesCsv
        {
            get => (string)GetValue(nameof(PinnedAreaStylesCsv));
            set => SetValue(nameof(PinnedAreaStylesCsv), value);
        }
    }
    ...
    public class TrafficToolEssentialsSettings : SettingsBackup
    {
        ...
        public int m_PanelTransparencyOption
        {
            get => (int)GetValue(nameof(m_PanelTransparencyOption));
            set => SetValue(nameof(m_PanelTransparencyOption), value);
        }
        public bool m_CompatibilityModeOption
        {
            get => (bool)GetValue(nameof(m_CompatibilityModeOption));
        ...
        public bool m_FlowRiversEnabledOption
        {
            get => (bool)GetValue(nameof(m_FlowRiversEnabledOption));
            set => SetValue(nameof(m_FlowRiversEnabledOption), value);
        }
        public bool m_FlowRivers
        {
            get => (bool)GetValue(nameof(m_FlowRivers));
            set => SetValue(nameof(m_FlowRivers), value);
        }
        public int m_FlowRiversColorMode
        {
            get => (int)GetValue(nameof(m_FlowRiversColorMode));
            set => SetValue(nameof(m_FlowRiversColorMode), value);
        }
        public bool m_FlowRiversColorblind
        {
            get => (bool)GetValue(nameof(m_FlowRiversColorblind));
            set => SetValue(nameof(m_FlowRiversColorblind), value);
        }
        public bool m_FlowRiversProblemsOnly
        {
            get => (bool)GetValue(nameof(m_FlowRiversProblemsOnly));
            set => SetValue(nameof(m_FlowRiversProblemsOnly), value);
        }
        public bool m_FlowRiversHideEmpty
        {
            get => (bool)GetValue(nameof(m_FlowRiversHideEmpty));
            set => SetValue(nameof(m_FlowRiversHideEmpty), value);
        }
        public bool m_FlowRiversShowGreenWave
        {
            get => (bool)GetValue(nameof(m_FlowRiversShowGreenWave));
            set => SetValue(nameof(m_FlowRiversShowGreenWave), value);
        }
        public bool m_FlowRiversShowHotspots
        {
            get => (bool)GetValue(nameof(m_FlowRiversShowHotspots));
            set => SetValue(nameof(m_FlowRiversShowHotspots), value);
        }
        public int m_UnsafeCrosswalkCostScaleOption
        {
            get => (int)GetValue(nameof(m_UnsafeCrosswalkCostScaleOption));
            set => SetValue(nameof(m_UnsafeCrosswalkCostScaleOption), value);
        }
        public int m_UnsafeCrosswalkCostScale
        {
            get => (int)GetValue(nameof(m_UnsafeCrosswalkCostScale));
            set => SetValue(nameof(m_UnsafeCrosswalkCostScale), value);
        }
        public int m_UnsafeUTurnCostScaleOption
        {
            get => (int)GetValue(nameof(m_UnsafeUTurnCostScaleOption));
            set => SetValue(nameof(m_UnsafeUTurnCostScaleOption), value);
        }
        public int m_UnsafeUTurnCostScale
        {
            get => (int)GetValue(nameof(m_UnsafeUTurnCostScale));
            set => SetValue(nameof(m_UnsafeUTurnCostScale), value);
        }
        public int m_TurningCostScaleOption
        {
            get => (int)GetValue(nameof(m_TurningCostScaleOption));
            set => SetValue(nameof(m_TurningCostScaleOption), value);
        }
        public int m_TurningCostScale
        {
            get => (int)GetValue(nameof(m_TurningCostScale));
            set => SetValue(nameof(m_TurningCostScale), value);
        }
        public int m_LaneCrossCostScaleOption
        {
            get => (int)GetValue(nameof(m_LaneCrossCostScaleOption));
            set => SetValue(nameof(m_LaneCrossCostScaleOption), value);
        }
        public int m_LaneCrossCostScale
        {
            get => (int)GetValue(nameof(m_LaneCrossCostScale));
            set => SetValue(nameof(m_LaneCrossCostScale), value);
        }
    }
    ...
    public class TransitTimetablesSettings : SettingsBackup
    {
        public bool Enabled
        {
            get => (bool)GetValue(nameof(Enabled));
        ...
        {
            get => (int)GetValue(nameof(VehicleCounts));
            set => SetValue(nameof(VehicleCounts), value);
        }
        public bool ManageVehicleCount
        {
            get => (bool)GetValue(nameof(ManageVehicleCount));
            set => SetValue(nameof(ManageVehicleCount), value);
        }
        public bool ProvisionRealFleet
        {
            get => (bool)GetValue(nameof(ProvisionRealFleet));
            set => SetValue(nameof(ProvisionRealFleet), value);
        }
        public bool RealisticTravelTime
        {
            get => (bool)GetValue(nameof(RealisticTravelTime));
            set => SetValue(nameof(RealisticTravelTime), value);
        }
        public bool MigrationNoticeAnswered
        {
            get => (bool)GetValue(nameof(MigrationNoticeAnswered));
            set => SetValue(nameof(MigrationNoticeAnswered), value);
        }
        public bool RealismNoticeAnswered
        {
            get => (bool)GetValue(nameof(RealismNoticeAnswered));
            set => SetValue(nameof(RealismNoticeAnswered), value);
        }
        public int MorningPeakStart
        {
            get => (int)GetValue(nameof(MorningPeakStart));
            set => SetValue(nameof(MorningPeakStart), value);
        }
        public int MorningPeakEnd
        {
            get => (int)GetValue(nameof(MorningPeakEnd));
            set => SetValue(nameof(MorningPeakEnd), value);
        }
        public int EveningPeakStart
        {
            get => (int)GetValue(nameof(EveningPeakStart));
            set => SetValue(nameof(EveningPeakStart), value);
        }
        public int EveningPeakEnd
        {
            get => (int)GetValue(nameof(EveningPeakEnd));
            set => SetValue(nameof(EveningPeakEnd), value);
        }
        public int NightStart
        {
            get => (int)GetValue(nameof(NightStart));
            set => SetValue(nameof(NightStart), value);
        }
        public int NightEnd
        {
            get => (int)GetValue(nameof(NightEnd));
            set => SetValue(nameof(NightEnd), value);
        }
        public bool StopAtEveryStop
        {
            get => (bool)GetValue(nameof(StopAtEveryStop));
            set => SetValue(nameof(StopAtEveryStop), value);
        }
        public int MaxDwellRoad
        {
            get => (int)GetValue(nameof(MaxDwellRoad));
            set => SetValue(nameof(MaxDwellRoad), value);
        }
        public int MaxDwellRail
        {
            get => (int)GetValue(nameof(MaxDwellRail));
            set => SetValue(nameof(MaxDwellRail), value);
        }
        public bool RealisticTripsCompat
        {
            get => (bool)GetValue(nameof(RealisticTripsCompat));
            set => SetValue(nameof(RealisticTripsCompat), value);
        }
    }
    ...
    public class TreeControllerSettings : SettingsBackup
    {
        ...
        public bool HideSlopeLimits
        {
            get => (bool)GetValue(nameof(HideSlopeLimits));
            set => SetValue(nameof(HideSlopeLimits), value);
        }
        ...
        public float MaxTreeSlope
        {
            get => (float)GetValue(nameof(MaxTreeSlope));
            set => SetValue(nameof(MaxTreeSlope), value);
        }
    }
    ...
    public class UnlockFeesAndPrivatizeSettings : SettingsBackup
    {
        public bool Enabled
        {
            get => (bool)GetValue(nameof(Enabled));
        ...
        public bool UnlockFees
        {
            get => (bool)GetValue(nameof(UnlockFees));
            set => SetValue(nameof(UnlockFees), value);
        }
        public bool PublicHealthcare
        {
            get => (bool)GetValue(nameof(PublicHealthcare));
            set => SetValue(nameof(PublicHealthcare), value);
        }
    }
    ...
    public class WriteEverywhereSettings : SettingsBackup
    {
        ...
        {
            get => (int)GetValue(nameof(TemplateItemsPerFrame));
            set => SetValue(nameof(TemplateItemsPerFrame), value);
        }
