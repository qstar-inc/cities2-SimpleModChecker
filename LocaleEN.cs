    ...
    public class LocaleEN(Setting setting) : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionGroupLocaleID(Setting.ModVerifyGroup), Setting.ModVerifyGroup },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.ShowNotif)), "Enable the Main Menu notification." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.PlaySound)), "Play Sound?" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.PlaySound)), "Enable playing a small audio sound on mods loading completed." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.DisableContinueOnLauncher)), "Disable \"Resume\" button on the Paradox Launcher?" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.DisableContinueOnLauncher)), "Disable showing the \"Resume\" button on the Paradox Launcher, so it's not clicked accidentally." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.DisableContinueInGame)), "Disable \"Continue Game\" button on the Main Menu?" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.DisableContinueInGame)), "Disable showing the \"Continue Game\" button on the Main Menu, so it's not clicked accidentally." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.DeleteCorrupted)), "Auto delete Corrupted Settings?" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.DeleteCorrupted)), "Enable the automatic deletion of corrupted settings (game or mod)." },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.AutoRestoreSettingBackupOnStartup)), "Enable the automatic restoring of all game settings, supported mods settings and all keybinds from Profile 1 when the game starts." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.EnableVerboseLogging)), "Enable Verbose Logging?" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.EnableVerboseLogging)), "Enable detailed logging to catch issues (only to be used for debugging purpose)." },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.ModFolderDropdown)), "Select Mod for Verification" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.ModFolderDropdown)), "Select a mod package and to verify only that package." },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.VerifyModSelected)), "Verify Selected Mod" },
